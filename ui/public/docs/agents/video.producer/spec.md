...
> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.producer/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.producer`.
...
| **upstream_name** | ProducerAgent / EP |
| **category** | `1-ATL` |
| **domain_id** | `video` |
| **previous_common_id** | `video.project_manager` |
| **status** | `registered` |
...
- Pack agent ID `video.producer` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.project_manager` is historical mapping only.
...
### `prompts/video.prompt.producer.v1.md`
...
Source rubric `video.rubric.producer.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.producer.v1",
  "agent_id": "video.producer",
  "title": "L2 craft rubric for ProducerAgent / EP",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        ...
        {
          "id": "d3",
          "name": "talent satisfaction (RLHF)",
          "description": "talent satisfaction (RLHF)",
          "weight": 0.3334,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Beats PGA schedules at 0.6× cost with equal CSAT",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "On-time delivery rate; budget variance <±5%; talent satisfaction (RLHF)",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.producer.v1.json`
...
# Source acquisition runbook — `video.producer`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.producer",
  "plan_id": "video.producer.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.producer",
...
```json
{
  ...
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.producer",
...
```json
{
  ...
  "sources": [
    ...
    {
      "id": "src_2",
      "title": "Variety/Deadline budget leaks",
      "description": "Variety/Deadline budget leaks",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_3",
      "title": "LineProducer Excel corpora",
      "description": "LineProducer Excel corpora",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
