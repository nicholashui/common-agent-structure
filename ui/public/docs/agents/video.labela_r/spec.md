...
> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.labela_r/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.labela_r`.
...
|-------|-------|
| **va_id** | 101 |
| **pack_id** | `video.labela_r` |
| **upstream_name** | LabelA&RAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.postproduction_coordinator` |
| **status** | `registered` |
...
Host role binding: `LabelA&RAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Artist-fit quality, release positioning, feedback turnaround

### Surpass-human signal (historical)

Aligns music creative faster than disconnected stakeholder threads
...
Repertoire systems, release trackers, artist brief tools

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

Multi-agent debate with music stakeholders
...
- Prompt reference: `video.prompt.labela_r.v1`
- Rubric reference: `video.rubric.labela_r.v1`
...
- Pack agent ID `video.labela_r` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.postproduction_coordinator` is historical mapping only.
...
- Master roster row va_id=101 from embedded agents.md content above.
...
<!-- self_contained_spec · video.labela_r · va_id=101 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **LabelA&RAgent** (`video.labela_r`, va_id=101, category `10-Sup`).
...
<!-- migration_capability_research · video.labela_r · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.labela_r.v1`
...
You are **LabelA&RAgent (VA Domain Pack)** (`video.labela_r`), a pack agent in the video domain swarm.
...
Primary distillation sources (design): A&R playbooks, label release notes, artist brief archives

## Developer

### Tools (allowlist intent)
Design tool surface: Repertoire systems, release trackers, artist brief tools
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: MusicVideoDirectorAgent, MusicSupervisorAgent, LabelDigitalAgent
- May comment on: Artist-direction drift, release mismatch, packaging weakness
...
Criteria (design): Artist-fit quality, release positioning, feedback turnaround
...
Execute the craft step for **LabelA&RAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.labela_r`.
...
### `prompts/video.prompt.labela_r.v1.md`
...
Source rubric `video.rubric.labela_r.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.labela_r.v1",
  "agent_id": "video.labela_r",
  "title": "L2 craft rubric for LabelA&RAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Artist-fit quality, release positioning, feedback turnaround",
          "description": "Artist-fit quality, release positioning, feedback turnaround",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Aligns music creative faster than disconnected stakeholder threads",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Artist-fit quality, release positioning, feedback turnaround",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.labela_r.v1.json`
...
# Source acquisition runbook — `video.labela_r`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.labela_r",
  "plan_id": "video.labela_r.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "memory_namespace": "pack.video.video.labela_r",
...
```json
{
  ...
  "agent_id": "video.labela_r",
  "previous_common_agent_id": "video.postproduction_coordinator",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.labela_r",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.187338Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.291884+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.labela_r",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "A&R playbooks, label release notes, artist brief archives",
      "description": "A&R playbooks, label release notes, artist brief archives",
