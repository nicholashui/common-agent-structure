# video.festivalstrategist — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.festivalstrategist/`.
...
# FestivalStrategistAgent

> Self-contained VA Domain Pack agent on host common-agent-swarm-ops.
> Pack agent ID matches pure VA/generic taxonomy: `video.festivalstrategist`.
...
|-------|-------|
| **va_id** | 94 |
| **pack_id** | `video.festivalstrategist` |
| **upstream_name** | FestivalStrategistAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.schedule_manager` |
| **status** | `registered` |
...
Host role binding: `FestivalStrategistAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Fit-to-festival strength, package readiness, timing discipline

### Surpass-human signal (historical)

Improves submission targeting versus generic release planning
...
Festival calendars, submission checklists, press-kit trackers

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

ReAct with calendar and package validation
...
- Prompt reference: `video.prompt.festivalstrategist.v1`
- Rubric reference: `video.rubric.festivalstrategist.v1`
...
- Pack agent ID `video.festivalstrategist` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.schedule_manager` is historical mapping only.
...
- Master roster row va_id=94 from embedded agents.md content above.
...
<!-- self_contained_spec · video.festivalstrategist · va_id=94 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **FestivalStrategistAgent** (`video.festivalstrategist`, va_id=94, category `10-Sup`).
...
<!-- migration_capability_research · video.festivalstrategist · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.festivalstrategist.v1`
...
You are **FestivalStrategistAgent (VA Domain Pack)** (`video.festivalstrategist`), a pack agent in the video domain swarm.
...
Design tool surface: Festival calendars, submission checklists, press-kit trackers
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: ProducerAgent / EP, DirectorAgent, CriticAgent
- May comment on: Weak positioning, mistimed submission plans, incomplete packages
...
Criteria (design): Fit-to-festival strength, package readiness, timing discipline
...
Execute the craft step for **FestivalStrategistAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.festivalstrategist`.
...
### `prompts/video.prompt.festivalstrategist.v1.md`
...
Source rubric `video.rubric.festivalstrategist.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.festivalstrategist.v1",
  "agent_id": "video.festivalstrategist",
  "title": "L2 craft rubric for FestivalStrategistAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Fit-to-festival strength, package readiness, timing discipline",
          "description": "Fit-to-festival strength, package readiness, timing discipline",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Improves submission targeting versus generic release planning",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Fit-to-festival strength, package readiness, timing discipline",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.festivalstrategist.v1.json`
...
# Source acquisition runbook — `video.festivalstrategist`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.festivalstrategist",
  "plan_id": "video.festivalstrategist.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "owner": "video.festivalstrategist",
  "cadence": "quarterly",
  "promotion_criteria": [
  ...
  "memory_namespace": "pack.video.video.festivalstrategist",
...
```json
{
  ...
  "sources": [
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Film Festival Secrets",
      "author": "Christopher Holland",
      "isbn13": "9781440441455",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Film Festival Secrets (Christopher Holland), ISBN-13 9781440441455"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Down and Dirty Pictures (Peter Biskind), ISBN-13 9780684862583"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
    ...
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Art of Leadership through Public Relations The Future of Effective Communication",
      "author": "Schober, Patrik",
      "isbn13": "9781837536337",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Art of Leadership through Public Relations The Future of Effective Communication (Schober, Patrik), ISBN-13 9781837536337"
    },
    {
      "kind": "reference_book",
      "language": "EN",
  ...
  "agent_id": "video.festivalstrategist",
  "previous_common_agent_id": "video.schedule_manager",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.festivalstrategist",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.155224Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.174622+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.festivalstrategist",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Festival submission guides, award-season strategies, selection histories",
      "description": "Festival submission guides, award-season strategies, selection histories",
