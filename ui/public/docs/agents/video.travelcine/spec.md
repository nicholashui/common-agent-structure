# video.travelcine — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.travelcine/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.travelcine`.
...
|-------|-------|
| **va_id** | 40 |
| **pack_id** | `video.travelcine` |
| **upstream_name** | TravelCineAgent |
| **category** | `7-Edu` |
| **domain_id** | `video` |
| **previous_common_id** | `video.procurement_advisor` |
| **status** | `registered` |
...
Host role binding: `TravelCineAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Establishing-shot diversity; location-mood match

### Surpass-human signal (historical)

Wins T+L preference at 0.1× sortie cost
...
Veo 3.1 (location gen); Google Earth Studio; AirMap geofence; Unsplash API

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

Self-Refine + geofence safety validator
...
- Prompt reference: `video.prompt.travelcine.v1`
- Rubric reference: `video.rubric.travelcine.v1`
...
- Pack agent ID `video.travelcine` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.procurement_advisor` is historical mapping only.
...
- Master roster row va_id=40 from embedded agents.md content above.
...
<!-- self_contained_spec · video.travelcine · va_id=40 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **TravelCineAgent** (`video.travelcine`, va_id=40, category `7-Edu`).
...
<!-- migration_capability_research · video.travelcine · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.travelcine.v1`
...
You are **TravelCineAgent (VA Domain Pack)** (`video.travelcine`), a pack agent in the video domain swarm.
...
Design tool surface: Veo 3.1 (location gen); Google Earth Studio; AirMap geofence; Unsplash API
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DirectorAgent, DronePilotAgent
- May comment on: DronePilotAgent (no-fly zone)
...
Criteria (design): Establishing-shot diversity; location-mood match
...
Execute the craft step for **TravelCineAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.travelcine`.
...
### `prompts/video.prompt.travelcine.v1.md`
...
Source rubric `video.rubric.travelcine.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.travelcine.v1",
  "agent_id": "video.travelcine",
  "title": "L2 craft rubric for TravelCineAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Establishing-shot diversity",
          "description": "Establishing-shot diversity",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "location-mood match",
          "description": "location-mood match",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Wins T+L preference at 0.1× sortie cost",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Establishing-shot diversity; location-mood match",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.travelcine.v1.json`
...
# Source acquisition runbook — `video.travelcine`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.travelcine",
  "plan_id": "video.travelcine.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.travelcine",
  ...
  "sources": [
    {
      ...
      "citation": "EN: The Art of Travel (Alain de Botton), ISBN-13 9780375725340"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Cinematography: Theory and Practice (Brown), ISBN-13 9781138212589"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
      "title": "旅行的艺术",
      "isbn13": "9787540452599",
      "origin": "spec/book_of_knowledge.md",
      "citation": "ZH: 旅行的艺术，ISBN-13 9787540452599"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
    ...
    },
    {
      ...
      "isbn13": "9781937538507",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Architectural Photography (Adrian Schulz), ISBN-13 9781937538507"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: On Photography (Sontag), ISBN-13 9780312420093"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
    ...
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Five Cs of Cinematography Motion Picture Filming Techniques",
      "author": "Joseph V. Mascelli",
      "isbn13": "9781879505414",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Five Cs of Cinematography Motion Picture Filming Techniques (Joseph V. Mascelli), ISBN-13 9781879505414"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
      "title": "电影照明技巧与创作",
      "author": "雷载兴",
      "isbn13": "9787106050399",
      "origin": "spec/book_of_knowledge.md",
      "citation": "ZH: 电影照明技巧与创作（雷载兴），ISBN-13 9787106050399"
    }
  ],
  "agent_id": "video.travelcine",
  "previous_common_agent_id": "video.procurement_advisor",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.travelcine",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.347136Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.945739+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.travelcine",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Brandon Li/Burkard reels",
      "description": "Brandon Li/Burkard reels",
    ...
    {
      "id": "src_2",
      "title": "NatGeo style guide",
      "description": "NatGeo style guide",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
