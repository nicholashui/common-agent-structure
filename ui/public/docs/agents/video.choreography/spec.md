# video.choreography — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.choreography/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.choreography`.
...
| **upstream_name** | ChoreographyAgent |
| **category** | `5-Perf` |
| **domain_id** | `video` |
| **previous_common_id** | `video.content_moderator` |
| **status** | `registered` |
...
Host role binding: `ChoreographyAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.choreography.v1`
- Rubric reference: `video.rubric.choreography.v1`
...
- Pack agent ID `video.choreography` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.content_moderator` is historical mapping only.
...
# Prompt — `video.prompt.choreography.v1`
...
You are **ChoreographyAgent (VA Domain Pack)** (`video.choreography`), a pack agent in the video domain swarm.
...
Design tool surface: Kling 3.0 motion control (reference video); Cascadeur; beat-detection (librosa)
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DirectorAgent, MVDirectorAgent
- May comment on: DirectorAgent (un-camera-friendly staging)
...
Criteria (design): Beat-sync accuracy; safety constraints; viral-pattern alignment
...
Execute the craft step for **ChoreographyAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.choreography`.
...
### `prompts/video.prompt.choreography.v1.md`
...
Source rubric `video.rubric.choreography.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.choreography.v1",
  "agent_id": "video.choreography",
  "title": "L2 craft rubric for ChoreographyAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Beat-sync accuracy",
          "description": "Beat-sync accuracy",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d3",
          "name": "viral-pattern alignment",
          "description": "viral-pattern alignment",
          "weight": 0.3334,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Wins blind preference vs choreographer drafts",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Beat-sync accuracy; safety constraints; viral-pattern alignment",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.choreography.v1.json`
...
# Source acquisition runbook — `video.choreography`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.choreography",
  "plan_id": "video.choreography.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.choreography",
...
```json
{
  ...
  "sources": [
    {
      ...
      "citation": "EN: The Intimate Act of Choreography (Blom & Chaplin), ISBN-13 9780822953425"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Laban for All",
      "author": "Newlove & Dalby",
      "isbn13": "9781854597250",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Laban for All (Newlove & Dalby), ISBN-13 9781854597250"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
  ...
  "agent_id": "video.choreography",
  "previous_common_agent_id": "video.content_moderator",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.choreography",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.069835Z",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Emmy Choreography submissions",
      "description": "Emmy Choreography submissions",
    ...
    {
      "id": "src_2",
      "title": "Goebel/Moore reels",
      "description": "Goebel/Moore reels",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_3",
      "title": "dance-notation datasets",
      "description": "dance-notation datasets",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
