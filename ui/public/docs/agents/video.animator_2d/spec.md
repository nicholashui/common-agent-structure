# video.animator_2d — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.animator_2d/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.animator_2d`.
...
|-------|-------|
| **va_id** | 12 |
| **pack_id** | `video.animator_2d` |
| **upstream_name** | AnimatorAgent (2D/3D) |
| **category** | `3-Edit` |
| **domain_id** | `video` |
| **previous_common_id** | `video.animation_director` |
| **status** | `registered` |
...
Host role binding: `AnimatorAgent (2D/3D) (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Beats junior on Annie rubric; equals senior at 5× throughput
...
Kling 3.0 motion control; Blender Python API; Cascadeur physics; Sync.so lip-sync
...
- Prompt reference: `video.prompt.animator_2d.v1`
- Rubric reference: `video.rubric.animator_2d.v1`
...
- Pack agent ID `video.animator_2d` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.animation_director` is historical mapping only.
...
- Master roster row va_id=12 from embedded agents.md content above.
...
<!-- self_contained_spec · video.animator_2d · va_id=12 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **AnimatorAgent (2D/3D)** (`video.animator_2d`, va_id=12, category `3-Edit`).
...
<!-- migration_capability_research · video.animator_2d · v1 · 2026-07-13 -->
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.animator_2d`.
...
### `prompts/video.prompt.animator_2d.v1.md`
...
Source rubric `video.rubric.animator_2d.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.animator_2d.v1",
  "agent_id": "video.animator_2d",
  "title": "L2 craft rubric for AnimatorAgent (2D/3D)",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "12-principles score",
          "description": "12-principles score",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d3",
          "name": "lip-sync phoneme accuracy",
          "description": "lip-sync phoneme accuracy",
          "weight": 0.3334,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Beats junior on Annie rubric; equals senior at 5× throughput",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "12-principles score; arc smoothness; lip-sync phoneme accuracy",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.animator_2d.v1.json`
...
# Source acquisition runbook — `video.animator_2d`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.animator_2d",
  "plan_id": "video.animator_2d.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3",
  ...
  "memory_namespace": "pack.video.video.animator_2d",
...
### `sources/generic/video.animator_2d.SPEC.md`
...
```json
{
  ...
  "sources": [
    ...
    },
    {
      ...
      "isbn13": "9781933492957",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Framed Ink (Marcos Mateu-Mestre), ISBN-13 9781933492957"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Directing the Story (Francis Glebas), ISBN-13 9780240810768"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Prepare to Board! 2nd ed.",
      "author": "Nancy Beiman",
      "isbn13": "9780240818788",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Prepare to Board! 2nd ed. (Nancy Beiman), ISBN-13 9780240818788"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Storyboards: Motion in Art, 3rd ed.",
      "author": "Mark Simon",
      "isbn13": "9780240808055",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Storyboards: Motion in Art, 3rd ed. (Mark Simon), ISBN-13 9780240808055"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
  ...
  "agent_id": "video.animator_2d",
  "previous_common_agent_id": "video.animation_director",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.animator_2d",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.625125Z",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Williams *Animator's Survival Kit*",
      "description": "Williams *Animator's Survival Kit*",
    ...
    {
      "id": "src_3",
      "title": "Pixar SparkShorts",
      "description": "Pixar SparkShorts",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_4",
      "title": "Blaise lessons",
      "description": "Blaise lessons",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
