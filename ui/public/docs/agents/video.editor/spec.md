...
> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.editor/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.editor`.
...
| **upstream_name** | EditorAgent |
| **category** | `3-Edit` |
| **domain_id** | `video` |
| **previous_common_id** | `video.edit_assembler` |
| **status** | `registered` |
...
Host role binding: `EditorAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.editor.v1`
- Rubric reference: `video.rubric.editor.v1`
...
- Pack agent ID `video.editor` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.edit_assembler` is historical mapping only.
...
You are **EditorAgent (VA Domain Pack)** (`video.editor`), a pack agent in the video domain swarm.
...
Primary distillation sources (design): Murch *In the Blink of an Eye*; ACE Eddie winners; Sundance editing labs

## Developer

### Tools (allowlist intent)
Design tool surface: DaVinci Resolve via MCP bridge; FFmpeg; EDL/XML timeline APIs
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DirectorAgent, AudienceSim, ComposerAgent (music-cut sync)
- May comment on: DirectorAgent (over-coverage), DoPAgent (unusable takes)
...
Criteria (design): Pacing curve matches genre; Murch "Rule of Six" score; AVD ≥ target
...
Execute the craft step for **EditorAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
### `prompts/video.prompt.editor.v1.md`
...
Source rubric `video.rubric.editor.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.editor.v1",
  "agent_id": "video.editor",
  "title": "L2 craft rubric for EditorAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Pacing curve matches genre",
          "description": "Pacing curve matches genre",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "Murch \"Rule of Six\" score",
          "description": "Murch \"Rule of Six\" score",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Wins ≥55% pairwise vs ACE-credited cuts",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Pacing curve matches genre; Murch \"Rule of Six\" score; AVD ≥ target",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.editor.v1.json`
...
# Source acquisition runbook — `video.editor`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.editor",
  "plan_id": "video.editor.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.editor",
...
```json
{
  ...
  "sources": [
    ...
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Guide to Managing Postproduction for Film, TV, and Digital Distribution",
      "author": "Barbara Clark, Susan Spohr, Dawn Higginbotham etc.",
      "isbn13": "9781138482814",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Guide to Managing Postproduction for Film, TV, and Digital Distribution (Barbara Clark, Susan Spohr, Dawn Higginbotham etc.), ISBN-13 9781138482814"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "author": "Lisa Kernan",
      "isbn13": "9780292797253",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Coming Attractions Reading American Movie Trailers (Lisa Kernan), ISBN-13 9780292797253"
    },
    {
      "kind": "reference_book",
      "language": "EN",
  ...
  "agent_id": "video.editor",
  "previous_common_agent_id": "video.edit_assembler",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.editor",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.685580Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.119430+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.editor",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Murch *In the Blink of an Eye*",
      "description": "Murch *In the Blink of an Eye*",
    ...
    {
      "id": "src_2",
      "title": "ACE Eddie winners",
      "description": "ACE Eddie winners",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_3",
      "title": "Sundance editing labs",
      "description": "Sundance editing labs",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
