# video.continuity — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.continuity/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.continuity`.
...
| **upstream_name** | ContinuityAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.continuity_supervisor` |
| **status** | `registered` |
...
Host role binding: `ContinuityAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.continuity.v1`
- Rubric reference: `video.rubric.continuity.v1`
...
- Pack agent ID `video.continuity` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.continuity_supervisor` is historical mapping only.
...
### `prompts/video.prompt.continuity.v1.md`
...
Source rubric `video.rubric.continuity.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.continuity.v1",
  "agent_id": "video.continuity",
  "title": "L2 craft rubric for ContinuityAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "State-drift detection, scene-to-scene consistency, manifest update correctness",
          "description": "State-drift detection, scene-to-scene consistency, manifest update correctness",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Catches continuity breaks earlier than end-of-post review",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "State-drift detection, scene-to-scene consistency, manifest update correctness",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.continuity.v1.json`
...
# Source acquisition runbook — `video.continuity`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.continuity",
  "plan_id": "video.continuity.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "memory_namespace": "pack.video.video.continuity",
...
### `sources/generic/video.continuity.SPEC.md`
  ...
  "sources": [
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Script Supervising and Film Continuity, 3rd ed.",
      "author": "Pat P. Miller",
      "isbn13": "9780240802947",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Script Supervising and Film Continuity, 3rd ed. (Pat P. Miller), ISBN-13 9780240802947"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Film Production Management 101, ISBN-13 9781615932290"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
    ...
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Beyond Continuity Script Supervision for the Modern Filmmaker",
      "author": "Mary Cybulski",
      "isbn13": "9780367423377",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Beyond Continuity Script Supervision for the Modern Filmmaker (Mary Cybulski), ISBN-13 9780367423377"
    }
  ],
  "agent_id": "video.continuity",
  "previous_common_agent_id": "video.continuity_supervisor",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.continuity",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.732297Z",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Continuity logs, script supervisor practices, asset manifest state tracking",
      "description": "Continuity logs, script supervisor practices, asset manifest state tracking",
