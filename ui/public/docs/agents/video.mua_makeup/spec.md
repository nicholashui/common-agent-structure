# video.mua_makeup — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.mua_makeup/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.mua_makeup`.
...
| **upstream_name** | MUAAgent (Makeup/Hair/SFX) |
| **category** | `3-Edit` |
| **domain_id** | `video` |
| **previous_common_id** | `video.escalation_manager` |
| **status** | `registered` |
...
Host role binding: `MUAAgent (Makeup/Hair/SFX) (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.mua_makeup.v1`
- Rubric reference: `video.rubric.mua_makeup.v1`
...
- Pack agent ID `video.mua_makeup` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.escalation_manager` is historical mapping only.
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.mua_makeup`.
...
### `prompts/video.prompt.mua_makeup.v1.md`
...
Source rubric `video.rubric.mua_makeup.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.mua_makeup.v1",
  "agent_id": "video.mua_makeup",
  "title": "L2 craft rubric for MUAAgent (Makeup/Hair/SFX)",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Continuity hash across takes",
          "description": "Continuity hash across takes",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "skin-tone realism (FID)",
          "description": "skin-tone realism (FID)",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Continuity break rate <0.5% (vs ~2% human)",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Continuity hash across takes; skin-tone realism (FID)",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.mua_makeup.v1.json`
...
# Source acquisition runbook — `video.mua_makeup`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.mua_makeup",
  "plan_id": "video.mua_makeup.distill.v1",
  "inputs": [
    "src_1",
    "src_2"
  ],
  ...
  "memory_namespace": "pack.video.video.mua_makeup",
  ...
  "sources": [
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Makeup Artist Handbook, 3rd ed.",
      "author": "Davis & Hall",
      "isbn13": "9781138240292",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Makeup Artist Handbook, 3rd ed. (Davis & Hall), ISBN-13 9781138240292"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Special Makeup Effects for Stage and Screen (Debreceni), ISBN-13 9781138047587"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "ZH: 化妆造型设计，ISBN-13 9787506492188"
    },
    {
      "kind": "reference_book",
      "language": "EN",
    ...
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "A Beginner’s Guide to Special Makeup Effects Monsters, Maniacs and More",
      "author": "Christopher Payne Andrew Kjos",
      "isbn13": "9781003093701",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: A Beginner’s Guide to Special Makeup Effects Monsters, Maniacs and More (Christopher Payne Andrew Kjos), ISBN-13 9781003093701"
    }
  ],
  "agent_id": "video.mua_makeup",
  "previous_common_agent_id": "video.escalation_manager",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.mua_makeup",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.240488Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.493408+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.mua_makeup",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "IATSE 706 corpora",
      "description": "IATSE 706 corpora",
    ...
    {
      "id": "src_2",
      "title": "Kazu Hiro studio refs",
      "description": "Kazu Hiro studio refs",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
