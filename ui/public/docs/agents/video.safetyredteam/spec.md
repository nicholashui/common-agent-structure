# video.safetyredteam — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.safetyredteam/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.safetyredteam`.
...
| **upstream_name** | SafetyRedTeamAgent |
| **category** | `9-Meta` |
| **domain_id** | `video` |
| **previous_common_id** | `video.safety_reviewer` |
| **status** | `registered` |
...
Host role binding: `SafetyRedTeamAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.safetyredteam.v1`
- Rubric reference: `video.rubric.safetyredteam.v1`
...
- Pack agent ID `video.safetyredteam` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.safety_reviewer` is historical mapping only.
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.safetyredteam`.
...
### `prompts/video.prompt.safetyredteam.v1.md`
...
Source rubric `video.rubric.safetyredteam.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.safetyredteam.v1",
  "agent_id": "video.safetyredteam",
  "title": "L2 craft rubric for SafetyRedTeamAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Attack-success kept ≤1%",
          "description": "Attack-success kept ≤1%",
          "weight": 0.5,
          "threshold_hint": "≤1%",
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Higher coverage than internal red-team rotation",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Attack-success kept ≤1%; taxonomy coverage",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.safetyredteam.v1.json`
...
# Source acquisition runbook — `video.safetyredteam`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.safetyredteam",
  "plan_id": "video.safetyredteam.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.safetyredteam",
...
```json
{
  ...
  "agent_id": "video.safetyredteam",
  "previous_common_agent_id": "video.safety_reviewer",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.safetyredteam",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.775150Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.756893+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.safetyredteam",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Hany Farid benchmarks",
      "description": "Hany Farid benchmarks",
    ...
    },
    {
      ...
      "description": "Partnership on AI Framework",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
