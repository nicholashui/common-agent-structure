# video.roasoptimizer — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.roasoptimizer/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.roasoptimizer`.
...
|-------|-------|
| **va_id** | 77 |
| **pack_id** | `video.roasoptimizer` |
| **upstream_name** | ROASOptimizerAgent |
| **category** | `9-Meta` |
| **domain_id** | `video` |
| **previous_common_id** | `video.graph_topology_designer` |
| **status** | `registered` |
...
Host role binding: `ROASOptimizerAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Beats senior marketer at equal budget
...
Meta Ads API (creative testing); TikTok Ads; Bayesian MMM tools (Robyn/Meridian)

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

RLAIF (reward = real ROAS from ad platform feedback)
...
- Prompt reference: `video.prompt.roasoptimizer.v1`
- Rubric reference: `video.rubric.roasoptimizer.v1`
...
- Pack agent ID `video.roasoptimizer` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.graph_topology_designer` is historical mapping only.
...
- Master roster row va_id=77 from embedded agents.md content above.
...
<!-- self_contained_spec · video.roasoptimizer · va_id=77 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **ROASOptimizerAgent** (`video.roasoptimizer`, va_id=77, category `9-Meta`).
...
<!-- migration_capability_research · video.roasoptimizer · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.roasoptimizer.v1`
...
You are **ROASOptimizerAgent (VA Domain Pack)** (`video.roasoptimizer`), a pack agent in the video domain swarm.
...
Design tool surface: Meta Ads API (creative testing); TikTok Ads; Bayesian MMM tools (Robyn/Meridian)
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: PerformanceMarketerAgent, AnalystAgent
- May comment on: UGCAgent (low hook), CopywriterAgent (weak CTA)
...
Criteria (design): ROAS uplift vs control; significance ≥95%
...
Execute the craft step for **ROASOptimizerAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.roasoptimizer`.
...
### `prompts/video.prompt.roasoptimizer.v1.md`
...
Source rubric `video.rubric.roasoptimizer.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.roasoptimizer.v1",
  "agent_id": "video.roasoptimizer",
  "title": "L2 craft rubric for ROASOptimizerAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "ROAS uplift vs control",
          "description": "ROAS uplift vs control",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "significance ≥95%",
          "description": "significance ≥95%",
          "weight": 0.5,
          "threshold_hint": "≥95%",
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Beats senior marketer at equal budget",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "ROAS uplift vs control; significance ≥95%",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.roasoptimizer.v1.json`
...
# Source acquisition runbook — `video.roasoptimizer`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.roasoptimizer",
  "plan_id": "video.roasoptimizer.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.roasoptimizer",
...
### `sources/generic/video.router.SPEC.md`
...
```json
{
  ...
  "agent_id": "video.roasoptimizer",
  "previous_common_agent_id": "video.graph_topology_designer",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.roasoptimizer",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.301131Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.716772+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.roasoptimizer",
...
```json
{
  ...
  "sources": [
    ...
    },
    {
      ...
      "description": "TikTok Ads Academy",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
