# video.benchmarkresearch — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.benchmarkresearch/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.benchmarkresearch`.
...
|-------|-------|
| **va_id** | 72 |
| **pack_id** | `video.benchmarkresearch` |
| **upstream_name** | BenchmarkResearchAgent |
| **category** | `9-Meta` |
| **domain_id** | `video` |
| **previous_common_id** | `video.translation_reviewer` |
| **status** | `registered` |
...
Host role binding: `BenchmarkResearchAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Coverage of benchmarks; freshness ≤7 days

### Surpass-human signal (historical)

Faster + broader than ML-research team
...
Papers-with-Code API; HuggingFace Hub API; arXiv RSS; VBench leaderboard scraper

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

ReAct (poll leaderboards → detect change → alert)
...
- Prompt reference: `video.prompt.benchmarkresearch.v1`
- Rubric reference: `video.rubric.benchmarkresearch.v1`
...
- Pack agent ID `video.benchmarkresearch` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.translation_reviewer` is historical mapping only.
...
- Master roster row va_id=72 from embedded agents.md content above.
...
<!-- self_contained_spec · video.benchmarkresearch · va_id=72 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **BenchmarkResearchAgent** (`video.benchmarkresearch`, va_id=72, category `9-Meta`).
...
<!-- migration_capability_research · video.benchmarkresearch · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.benchmarkresearch.v1`
...
You are **BenchmarkResearchAgent (VA Domain Pack)** (`video.benchmarkresearch`), a pack agent in the video domain swarm.
...
Design tool surface: Papers-with-Code API; HuggingFace Hub API; arXiv RSS; VBench leaderboard scraper
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: OptimizationAgents (any)
- May comment on: All AI agents (stale baselines)
...
Criteria (design): Coverage of benchmarks; freshness ≤7 days
...
Execute the craft step for **BenchmarkResearchAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.benchmarkresearch`.
...
### `prompts/video.prompt.benchmarkresearch.v1.md`
...
Source rubric `video.rubric.benchmarkresearch.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.benchmarkresearch.v1",
  "agent_id": "video.benchmarkresearch",
  "title": "L2 craft rubric for BenchmarkResearchAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Coverage of benchmarks",
          "description": "Coverage of benchmarks",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "freshness ≤7 days",
          "description": "freshness ≤7 days",
          "weight": 0.5,
          "threshold_hint": "≤7",
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Faster + broader than ML-research team",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Coverage of benchmarks; freshness ≤7 days",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.benchmarkresearch.v1.json`
...
# Source acquisition runbook — `video.benchmarkresearch`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.benchmarkresearch",
  "plan_id": "video.benchmarkresearch.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.benchmarkresearch",
...
```json
{
  ...
  "agent_id": "video.benchmarkresearch",
  "previous_common_agent_id": "video.translation_reviewer",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.benchmarkresearch",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.055681Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:27.717362+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.benchmarkresearch",
...
```json
{
  ...
  "sources": [
    ...
    {
      "id": "src_2",
      "title": "HuggingFace leaderboards",
      "description": "HuggingFace leaderboards",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
