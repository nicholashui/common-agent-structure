# video.cinematographer — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.cinematographer/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.cinematographer`.
...
| **upstream_name** | CinematographerAgent (DoP) |
| **category** | `2-Cam` |
| **domain_id** | `video` |
| **previous_common_id** | `video.cinematography_planner` |
| **status** | `registered` |
...
Host role binding: `CinematographerAgent (DoP) (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.cinematographer.v1`
- Rubric reference: `video.rubric.cinematographer.v1`
...
- Pack agent ID `video.cinematographer` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.cinematography_planner` is historical mapping only.
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.cinematographer`.
...
### `prompts/video.prompt.cinematographer.v1.md`
...
Source rubric `video.rubric.cinematographer.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.cinematographer.v1",
  "agent_id": "video.cinematographer",
  "title": "L2 craft rubric for CinematographerAgent (DoP)",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Rule-of-thirds/leading-lines score",
          "description": "Rule-of-thirds/leading-lines score",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "exposure histogram in zone",
          "description": "exposure histogram in zone",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d3",
          "name": "color-temp consistency",
          "description": "color-temp consistency",
          "weight": 0.3334,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Beats ASC peer-juried reels in blind aesthetic preference",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Rule-of-thirds/leading-lines score; exposure histogram in zone; color-temp consistency",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.cinematographer.v1.json`
...
# Source acquisition runbook — `video.cinematographer`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.cinematographer",
  "plan_id": "video.cinematographer.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3",
  ...
  "memory_namespace": "pack.video.video.cinematographer",
...
```json
{
  ...
  "agent_id": "video.cinematographer",
  "previous_common_agent_id": "video.cinematography_planner",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.cinematographer",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.572099Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:27.806375+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.cinematographer",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "ASC Magazine 1980–present",
      "description": "ASC Magazine 1980–present",
    ...
    {
      "id": "src_3",
      "title": "Brown *Cinematography: Theory & Practice*",
      "description": "Brown *Cinematography: Theory & Practice*",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_4",
      "title": "Cannes shot-libraries",
      "description": "Cannes shot-libraries",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
