# video.marketing — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.marketing/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.marketing`.
...
| **upstream_name** | MarketingAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.campaign_manager` |
| **status** | `registered` |
...
- Pack agent ID `video.marketing` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.campaign_manager` is historical mapping only.
...
# Prompt — `video.prompt.marketing.v1`
...
You are **MarketingAgent (VA Domain Pack)** (`video.marketing`), a pack agent in the video domain swarm.
...
Primary distillation sources (design): Campaign playbooks, launch calendars, media plans, asset packaging requirements

## Developer

### Tools (allowlist intent)
Design tool surface: Campaign management suites, metadata tools, release planners
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: SocialMediaStrategistAgent, SEOAgent, CopywriterAgent, TrailerEditorAgent
- May comment on: Missing formats, weak rollout timing, incomplete promotion sets
...
Criteria (design): Metadata completeness, asset readiness, launch sequencing accuracy
...
Execute the craft step for **MarketingAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.marketing`.
...
### `prompts/video.prompt.marketing.v1.md`
...
Source rubric `video.rubric.marketing.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.marketing.v1",
  "agent_id": "video.marketing",
  "title": "L2 craft rubric for MarketingAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Metadata completeness, asset readiness, launch sequencing accuracy",
          "description": "Metadata completeness, asset readiness, launch sequencing accuracy",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Ships multi-channel launch packages faster than manual campaign ops",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Metadata completeness, asset readiness, launch sequencing accuracy",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.marketing.v1.json`
...
# Source acquisition runbook — `video.marketing`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.marketing",
  "plan_id": "video.marketing.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "memory_namespace": "pack.video.video.marketing",
...
### `sources/generic/video.performancemarketer.SPEC.md`
...
|-------|-------|
| **va_id** | 31 |
| **pack_id** | `video.performancemarketer` |
| **category** | `6-Dist` |
| **domain_id** | `video` |
...
| 84 | **BrandAgent** | Enforces brand voice, claims boundaries, and visual consistency | Brand books, approved campaigns, legal claim guardrails, tone guides | Brand-voice similarity, policy adherence, low deviation across assets | Holds cross-channel brand consistency better than fragmented human review | CopywriterAgent, MotionGraphicsAgent, MarketingAgent, BrandStrategistAgent | Voice drift, visual inconsistency, claim creep | Brand asset library, embedding similarity, style guides | Self-Refine against brand constitution |
| 85 | **BrandStrategistAgent** | Defines audience-value framing and positioning before script and campaign execution | Positioning frameworks, campaign strategy decks, market research, brand architecture docs | Strategy coherence, differentiation strength, audience-message clarity | Produces clearer brand-to-script translation than ad hoc human handoffs | BrandAgent, ScreenwriterAgent, MarketingAgent | Positioning gaps, weak value proposition, misaligned audience framing | Research decks, messaging frameworks, strategy templates | Multi-agent debate with BrandAgent and CreativeDirectorAgent |
| 86 | **MarketingAgent** | Packages content for launch, promotions, and release sequencing | Campaign playbooks, launch calendars, media plans, asset packaging requirements | Metadata completeness, asset readiness, launch sequencing accuracy | Ships multi-channel launch packages faster than manual campaign 
…
...
- Master roster row va_id=31 from embedded agents.md content above.
- Deep/extra text from `business/video/corpus/` and `C:\Project\va-agent-swarm`.
- Generator: `scripts/business/enrich_video_agent_specs.py`.
- Upstream project name (historical only): va-agent-swarm.


<!-- self_contained_spec · video.performancemarketer · va_id=31 -->

## Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **PerformanceMarketerAgent** (`video.performancemarketer`, va_id=31, category `6-Dist`).
...
<!-- migration_capability_research · video.performancemarketer · v1 · 2026-07-13 -->
...
```json
{
  ...
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.marketing",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Campaign playbooks, launch calendars, media plans, asset packaging requirements",
      "description": "Campaign playbooks, launch calendars, media plans, asset packaging requirements",
