# video.corrections — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.corrections/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.corrections`.
...
|-------|-------|
| **va_id** | 109 |
| **pack_id** | `video.corrections` |
| **upstream_name** | CorrectionsAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.technical_qc_reviewer` |
| **status** | `registered` |
...
Host role binding: `CorrectionsAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Correction turnaround, version replacement accuracy, notice completeness

### Surpass-human signal (historical)

Resolves post-release issues faster than unstructured incident handling
...
Version-control systems, publishing tools, correction trackers

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

ReAct over correction and replacement workflows
...
- Prompt reference: `video.prompt.corrections.v1`
- Rubric reference: `video.rubric.corrections.v1`
...
- Pack agent ID `video.corrections` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.technical_qc_reviewer` is historical mapping only.
...
| 84 | **BrandAgent** | Enforces brand voice, claims boundaries, and visual consistency | Brand books, approved campaigns, legal claim guardrails, tone guides | Brand-voice similarity, policy adherence, low deviation across assets | Holds cross-channel brand consistency better than fragmented human review | CopywriterAgent, MotionGraphicsAgent, MarketingAgent, BrandStrategistAgent | Voice drift, visual inconsistency, claim creep | Brand asset library, embedding similarity, style guides | Self-Refine against brand constitution |
| 85 | **BrandStrategistAgent** | Defines audience-value framing and positioning before script and campaign execution | Positioning frameworks, campaign strategy decks, market research, brand architecture docs | Strategy coherence, differentiation strength, audience-message clarity | Produces clearer brand-to-script translation than ad hoc human handoffs | BrandAgent, ScreenwriterAgent, MarketingAgent | Positioning gaps, weak value proposition, misaligned audience framing | Research decks, messaging frameworks, strategy templates | Multi-agent debate with BrandAgent and CreativeDirectorAgent |
| 86 | **MarketingAgent** | Packages content for launch, promotions, and release sequencing | Campaign playbooks, launch calendars, media plans, asset packaging requirements | Metadata completeness, asset readiness, launch sequencing accuracy | Ships multi-channel launch packages faster than manual campaign ops | SocialMediaStrategistAgent, SEOAgent, CopywriterAgent, TrailerEditorAgent | Missing formats, weak rollout timing, incomplete promotion sets | Campaign management suites, metadata tools, release planners | ReAct over launch checklists and chann
…
...
- Master roster row va_id=109 from embedded agents.md content above.
...
<!-- self_contained_spec · video.corrections · va_id=109 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **CorrectionsAgent** (`video.corrections`, va_id=109, category `10-Sup`).
...
<!-- migration_capability_research · video.corrections · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.corrections.v1`
...
You are **CorrectionsAgent (VA Domain Pack)** (`video.corrections`), a pack agent in the video domain swarm.
...
Design tool surface: Version-control systems, publishing tools, correction trackers
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: StandardsEditorAgent, FactCheckerAgent, ChannelManagerAgent
- May comment on: Unclosed correction loops, incomplete notices, stale versions
...
Criteria (design): Correction turnaround, version replacement accuracy, notice completeness
...
Execute the craft step for **CorrectionsAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.corrections`.
...
### `prompts/video.prompt.corrections.v1.md`
...
Source rubric `video.rubric.corrections.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.corrections.v1",
  "agent_id": "video.corrections",
  "title": "L2 craft rubric for CorrectionsAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Correction turnaround, version replacement accuracy, notice completeness",
          "description": "Correction turnaround, version replacement accuracy, notice completeness",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Resolves post-release issues faster than unstructured incident handling",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Correction turnaround, version replacement accuracy, notice completeness",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.corrections.v1.json`
...
# Source acquisition runbook — `video.corrections`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.corrections",
  "plan_id": "video.corrections.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "memory_namespace": "pack.video.video.corrections",
...
### `sources/generic/video.standardseditor.SPEC.md`

# StandardsEditorAgent
...
Reduces standards drift better than late-stage copy edits
...
Editorial checklists, attribution validators, standards DB

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

## Architecture pattern

Constitutional AI with editorial standards constitution
...
- Master roster row va_id=106 from embedded agents.md content above.
- Deep/extra text from `business/video/corpus/` and `C:\Project\va-agent-swarm`.
- Generator: `scripts/business/enrich_video_agent_specs.py`.
- Upstream project name (historical only): va-agent-swarm.


<!-- self_contained_spec · video.standardseditor · va_id=106 -->

## Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **StandardsEditorAgent** (`video.standardseditor`, va_id=106, category `10-Sup`).
...
<!-- migration_capability_research · video.standardseditor · v1 · 2026-07-13 -->
...
```json
{
  ...
  "agent_id": "video.corrections",
  "previous_common_agent_id": "video.technical_qc_reviewer",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.corrections",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.114750Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:27.970226+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.corrections",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Corrections workflows, retraction and update policies, version tracking",
      "description": "Corrections workflows, retraction and update policies, version tracking",
