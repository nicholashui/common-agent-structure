...
> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.ethics/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.ethics`.
...
| **upstream_name** | EthicsAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.cultural_reviewer` |
| **status** | `registered` |
...
Host role binding: `EthicsAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.ethics.v1`
- Rubric reference: `video.rubric.ethics.v1`
...
- Pack agent ID `video.ethics` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.cultural_reviewer` is historical mapping only.
...
You are **EthicsAgent (VA Domain Pack)** (`video.ethics`), a pack agent in the video domain swarm.
...
Design tool surface: Ethics review templates, risk matrices, disclosure checklists
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: StandardsEditorAgent, ComplianceAgent (Legal), TrustSafetyAgent, SafetyRedTeamAgent
- May comment on: Disclosure insufficiency, fairness concerns, sensitive-content risk
...
Criteria (design): Ethical issue recall, mitigation clarity, escalation precision
...
Execute the craft step for **EthicsAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.ethics`.
...
### `prompts/video.prompt.ethics.v1.md`
...
Source rubric `video.rubric.ethics.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.ethics.v1",
  "agent_id": "video.ethics",
  "title": "L2 craft rubric for EthicsAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Ethical issue recall, mitigation clarity, escalation precision",
          "description": "Ethical issue recall, mitigation clarity, escalation precision",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Surfaces release risks earlier than reactive ethics review",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Ethical issue recall, mitigation clarity, escalation precision",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.ethics.v1.json`
...
# Source acquisition runbook — `video.ethics`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.ethics",
  "plan_id": "video.ethics.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "memory_namespace": "pack.video.video.ethics",
...
### `sources/generic/video.sme.SPEC.md`
...
```json
{
  ...
  "sources": [
    ...
    },
    {
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Alignment Problem, ISBN-13 9780393635829"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Weapons of Math Destruction, ISBN-13 9780553418811"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
  ...
  "agent_id": "video.ethics",
  "previous_common_agent_id": "video.cultural_reviewer",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.ethics",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.723455Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.143060+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "vendor/common-agent-swarm-ops/business/video/agents/video.ethics",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Ethics frameworks, synthetic-media disclosure guidance, fairness audits",
      "description": "Ethics frameworks, synthetic-media disclosure guidance, fairness audits",
