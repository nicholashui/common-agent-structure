# video.moodboard — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.moodboard/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.moodboard`.
...
|-------|-------|
| **va_id** | 63 |
| **pack_id** | `video.moodboard` |
| **upstream_name** | MoodBoardAgent |
| **category** | `9-Meta` |
| **domain_id** | `video` |
| **previous_common_id** | `video.human_review_coordinator` |
| **status** | `registered` |
...
Reference boards: visual, sonic, tonal

Host role binding: `MoodBoardAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Pinterest/Are.na; lookbook archives; Spotify-Canvas

### Self-quality criteria (historical)

Reference coherence (cluster tightness); brief alignment

### Surpass-human signal (historical)

Faster + tighter boards than art director (blind A/B)
...
Pinterest/Are.na APIs; Spotify Canvas; CLIP clustering; Figma board generation

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

ReAct (search → cluster → layout → validate coherence)
...
- Prompt reference: `video.prompt.moodboard.v1`
- Rubric reference: `video.rubric.moodboard.v1`
...
- Pack agent ID `video.moodboard` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.human_review_coordinator` is historical mapping only.
...
- Master roster row va_id=63 from embedded agents.md content above.
...
<!-- self_contained_spec · video.moodboard · va_id=63 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **MoodBoardAgent** (`video.moodboard`, va_id=63, category `9-Meta`).
...
<!-- migration_capability_research · video.moodboard · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.moodboard.v1`
...
You are **MoodBoardAgent (VA Domain Pack)** (`video.moodboard`), a pack agent in the video domain swarm.
...
Design tool surface: Pinterest/Are.na APIs; Spotify Canvas; CLIP clustering; Figma board generation
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DirectorAgent, ProductionDesignAgent
- May comment on: ConceptArtistAgent (off-mood)
...
Criteria (design): Reference coherence (cluster tightness); brief alignment
...
Execute the craft step for **MoodBoardAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.moodboard`.
...
### `prompts/video.prompt.moodboard.v1.md`
...
Source rubric `video.rubric.moodboard.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.moodboard.v1",
  "agent_id": "video.moodboard",
  "title": "L2 craft rubric for MoodBoardAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Reference coherence (cluster tightness)",
          "description": "Reference coherence (cluster tightness)",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Faster + tighter boards than art director (blind A/B)",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Reference coherence (cluster tightness); brief alignment",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.moodboard.v1.json`
...
# Source acquisition runbook — `video.moodboard`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.moodboard",
  "plan_id": "video.moodboard.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.moodboard",
...
```json
{
  ...
  "agent_id": "video.moodboard",
  "previous_common_agent_id": "video.human_review_coordinator",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.moodboard",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.234142Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.435637+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.moodboard",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Pinterest/Are.na",
      "description": "Pinterest/Are.na",
