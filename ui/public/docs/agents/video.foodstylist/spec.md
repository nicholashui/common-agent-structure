# video.foodstylist — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.foodstylist/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.foodstylist`.
...
|-------|-------|
| **va_id** | 39 |
| **pack_id** | `video.foodstylist` |
| **upstream_name** | FoodStylistAgent |
| **category** | `7-Edu` |
| **domain_id** | `video` |
| **previous_common_id** | `video.resource_planner` |
| **status** | `registered` |
...
Camera-ready food, recipe authenticity

Host role binding: `FoodStylistAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
James Beard archives; Spungen techniques; IACP corpora

### Self-quality criteria (historical)

Visual appetite-appeal (aesthetic regressor); recipe accuracy

### Surpass-human signal (historical)

Wins blind preference vs editorial food stylist
...
DALL-E 3 / Midjourney (food-photo gen); recipe-step parser; aesthetic scoring model

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

Self-Refine (aesthetic regressor as rubric)
...
- Prompt reference: `video.prompt.foodstylist.v1`
- Rubric reference: `video.rubric.foodstylist.v1`
...
- Pack agent ID `video.foodstylist` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.resource_planner` is historical mapping only.
...
- Master roster row va_id=39 from embedded agents.md content above.
...
<!-- self_contained_spec · video.foodstylist · va_id=39 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **FoodStylistAgent** (`video.foodstylist`, va_id=39, category `7-Edu`).
...
<!-- migration_capability_research · video.foodstylist · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.foodstylist.v1`
...
You are **FoodStylistAgent (VA Domain Pack)** (`video.foodstylist`), a pack agent in the video domain swarm.
...
Design tool surface: DALL-E 3 / Midjourney (food-photo gen); recipe-step parser; aesthetic scoring model
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DoPAgent (lighting), DirectorAgent
- May comment on: ScriptwriterAgent (impossible recipe)
...
Criteria (design): Visual appetite-appeal (aesthetic regressor); recipe accuracy
...
Execute the craft step for **FoodStylistAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.foodstylist`.
...
### `prompts/video.prompt.foodstylist.v1.md`
...
Source rubric `video.rubric.foodstylist.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.foodstylist.v1",
  "agent_id": "video.foodstylist",
  "title": "L2 craft rubric for FoodStylistAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Visual appetite-appeal (aesthetic regressor)",
          "description": "Visual appetite-appeal (aesthetic regressor)",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "recipe accuracy",
          "description": "recipe accuracy",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Wins blind preference vs editorial food stylist",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Visual appetite-appeal (aesthetic regressor); recipe accuracy",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.foodstylist.v1.json`
...
# Source acquisition runbook — `video.foodstylist`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.foodstylist",
  "plan_id": "video.foodstylist.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.foodstylist",
...
```json
{
  ...
  "sources": [
    {
      ...
      "isbn13": "9780470080191",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Food Styling (Delores Custer), ISBN-13 9780470080191"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "isbn13": "9780321784100",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Food Photography (Nicole S. Young), ISBN-13 9780321784100"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: On Food and Cooking (Harold McGee), ISBN-13 9780684800011"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
    ...
    },
    {
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Light: Science & Magic, 5th ed., ISBN-13 9780415719407"
    },
    {
      "kind": "reference_book",
      "language": "EN",
  ...
  "agent_id": "video.foodstylist",
  "previous_common_agent_id": "video.resource_planner",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.foodstylist",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.161352Z",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "James Beard archives",
      "description": "James Beard archives",
    ...
    {
      "id": "src_2",
      "title": "Spungen techniques",
      "description": "Spungen techniques",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
