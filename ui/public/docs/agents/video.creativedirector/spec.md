# video.creativedirector — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.creativedirector/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.creativedirector`.
...
| **upstream_name** | CreativeDirectorAgent |
| **category** | `6-Dist` |
| **domain_id** | `video` |
| **previous_common_id** | `video.creative_director` |
| **status** | `registered` |
...
Host role binding: `CreativeDirectorAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.creativedirector.v1`
- Rubric reference: `video.rubric.creativedirector.v1`
...
- Pack agent ID `video.creativedirector` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.creative_director` is historical mapping only.
...
### `prompts/video.prompt.creativedirector.v1.md`
...
Source rubric `video.rubric.creativedirector.v1.json` (baseline_safe; not a production pass).
...
### `rubrics/video.rubric.creativedirector.v1.json`
...
# Source acquisition runbook — `video.creativedirector`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.creativedirector",
  "plan_id": "video.creativedirector.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.creativedirector",
...
### `sources/generic/video.creativedirector.SPEC.md`
...
```json
{
  ...
  "agent_id": "video.creativedirector",
  "previous_common_agent_id": "video.creative_director",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.creativedirector",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.497114Z",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Cannes Lions Grand Prix",
      "description": "Cannes Lions Grand Prix",
    ...
    },
    {
      ...
      "description": "agency case studies",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
