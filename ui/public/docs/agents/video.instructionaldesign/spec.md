# video.instructionaldesign — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.instructionaldesign/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.instructionaldesign`.
...
|-------|-------|
| **va_id** | 32 |
| **pack_id** | `video.instructionaldesign` |
| **upstream_name** | InstructionalDesignAgent |
| **category** | `7-Edu` |
| **domain_id** | `video` |
| **previous_common_id** | `video.vendor_coordinator` |
| **status** | `registered` |
...
Host role binding: `InstructionalDesignAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Bloom-level mapping; completion ≥70%; Kirkpatrick L2 quiz ≥80%

### Surpass-human signal (historical)

Beats ATD-credentialed ID on retention RCT
...
LMS APIs (SCORM/xAPI); quiz generation; Bloom taxonomy classifier
...
- Prompt reference: `video.prompt.instructionaldesign.v1`
- Rubric reference: `video.rubric.instructionaldesign.v1`
...
- Pack agent ID `video.instructionaldesign` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.vendor_coordinator` is historical mapping only.
...
- Master roster row va_id=32 from embedded agents.md content above.
...
<!-- self_contained_spec · video.instructionaldesign · va_id=32 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **InstructionalDesignAgent** (`video.instructionaldesign`, va_id=32, category `7-Edu`).
...
<!-- migration_capability_research · video.instructionaldesign · v1 · 2026-07-13 -->
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.instructionaldesign`.
...
### `prompts/video.prompt.instructionaldesign.v1.md`
...
Source rubric `video.rubric.instructionaldesign.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.instructionaldesign.v1",
  "agent_id": "video.instructionaldesign",
  "title": "L2 craft rubric for InstructionalDesignAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Bloom-level mapping",
          "description": "Bloom-level mapping",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d3",
          "name": "Kirkpatrick L2 quiz ≥80%",
          "description": "Kirkpatrick L2 quiz ≥80%",
          "weight": 0.3334,
          "threshold_hint": "≥80%",
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Beats ATD-credentialed ID on retention RCT",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Bloom-level mapping; completion ≥70%; Kirkpatrick L2 quiz ≥80%",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.instructionaldesign.v1.json`
...
# Source acquisition runbook — `video.instructionaldesign`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.instructionaldesign",
  "plan_id": "video.instructionaldesign.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "owner": "video.instructionaldesign",
  "cadence": "quarterly",
  "promotion_criteria": [
  ...
  "memory_namespace": "pack.video.video.instructionaldesign",
...
```json
{
  ...
  "agent_id": "video.instructionaldesign",
  "previous_common_agent_id": "video.vendor_coordinator",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.instructionaldesign",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.166627Z",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "ATD body of knowledge",
      "description": "ATD body of knowledge",
    ...
    {
      "id": "src_2",
      "title": "Cathy Moore *Action Mapping*",
      "description": "Cathy Moore *Action Mapping*",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_3",
      "title": "Dirksen *Design for How People Learn*",
      "description": "Dirksen *Design for How People Learn*",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
