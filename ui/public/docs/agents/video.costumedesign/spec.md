# video.costumedesign — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.costumedesign/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.costumedesign`.
...
|-------|-------|
| **va_id** | 17 |
| **pack_id** | `video.costumedesign` |
| **upstream_name** | CostumeDesignAgent |
| **category** | `3-Edit` |
| **domain_id** | `video` |
| **previous_common_id** | `video.model_input_recorder` |
| **status** | `registered` |
...
Host role binding: `CostumeDesignAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Period/fashion accuracy; silhouette read; palette fit

### Surpass-human signal (historical)

Beats CDG juniors on period accuracy benchmarks
...
Fashion-history vector DB (V&A/Met API); image-gen for costume sketches; color-palette tools

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

Self-Refine (period-accuracy rubric)
...
- Prompt reference: `video.prompt.costumedesign.v1`
- Rubric reference: `video.rubric.costumedesign.v1`
...
- Pack agent ID `video.costumedesign` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.model_input_recorder` is historical mapping only.
...
- Master roster row va_id=17 from embedded agents.md content above.
...
<!-- self_contained_spec · video.costumedesign · va_id=17 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **CostumeDesignAgent** (`video.costumedesign`, va_id=17, category `3-Edit`).
...
<!-- migration_capability_research · video.costumedesign · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.costumedesign.v1`
...
You are **CostumeDesignAgent (VA Domain Pack)** (`video.costumedesign`), a pack agent in the video domain swarm.
...
Design tool surface: Fashion-history vector DB (V&A/Met API); image-gen for costume sketches; color-palette tools
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DirectorAgent, ProductionDesignAgent
- May comment on: MUAAgent (continuity break)
...
Criteria (design): Period/fashion accuracy; silhouette read; palette fit
...
Execute the craft step for **CostumeDesignAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.costumedesign`.
...
### `prompts/video.prompt.costumedesign.v1.md`
...
Source rubric `video.rubric.costumedesign.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.costumedesign.v1",
  "agent_id": "video.costumedesign",
  "title": "L2 craft rubric for CostumeDesignAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Period/fashion accuracy",
          "description": "Period/fashion accuracy",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Beats CDG juniors on period accuracy benchmarks",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Period/fashion accuracy; silhouette read; palette fit",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.costumedesign.v1.json`
...
# Source acquisition runbook — `video.costumedesign`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.costumedesign",
  "plan_id": "video.costumedesign.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.costumedesign",
  ...
  "sources": [
    {
      ...
      "isbn13": "9780240805900",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Costume Design (Deborah Nadoolman Landis), ISBN-13 9780240805900"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Hollywood Costume",
      "author": "Landis, ed.",
      "isbn13": "9781419709821",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Hollywood Costume (Landis, ed.), ISBN-13 9781419709821"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
    ...
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Production Design for Screen",
      "author": "Jane Barnwell",
      "isbn13": "9781474254786",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Production Design for Screen (Jane Barnwell), ISBN-13 9781474254786"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "If It's Purple, Someone's Gonna Die",
      "author": "Patti Bellantoni",
      "isbn13": "9780240806884",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: If It's Purple, Someone's Gonna Die (Patti Bellantoni), ISBN-13 9780240806884"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "FilmCraft Costume Design",
      "author": "Deborah Nadoolman Landis",
      "isbn13": "9781908150844",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: FilmCraft Costume Design (Deborah Nadoolman Landis), ISBN-13 9781908150844"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Designing Costume for Stage and Screen",
      "author": "Deirdre Clancy",
      "isbn13": "9781849941983",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Designing Costume for Stage and Screen (Deirdre Clancy), ISBN-13 9781849941983"
    }
  ],
  "agent_id": "video.costumedesign",
  "previous_common_agent_id": "video.model_input_recorder",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.costumedesign",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.121295Z",
...
```json
{
  ...
  "sources": [
    ...
    {
      "id": "src_2",
      "title": "CDG monographs",
      "description": "CDG monographs",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_3",
      "title": "Ruth E. Carter masterclass",
      "description": "Ruth E. Carter masterclass",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
