# video.signlanguageinterpreter — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.signlanguageinterpreter/`.
...
# SignLanguageInterpreterAgent

> Self-contained VA Domain Pack agent on host common-agent-swarm-ops.
> Pack agent ID matches pure VA/generic taxonomy: `video.signlanguageinterpreter`.
...
|-------|-------|
| **va_id** | 43 |
| **pack_id** | `video.signlanguageinterpreter` |
| **upstream_name** | SignLanguageInterpreterAgent |
| **category** | `7-Edu` |
| **domain_id** | `video` |
| **previous_common_id** | `video.regression_analyst` |
| **status** | `registered` |
...
- Pack agent ID `video.signlanguageinterpreter` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.regression_analyst` is historical mapping only.
...
- Master roster row va_id=43 from embedded agents.md content above.
...
<!-- self_contained_spec · video.signlanguageinterpreter · va_id=43 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **SignLanguageInterpreterAgent** (`video.signlanguageinterpreter`, va_id=43, category `7-Edu`).
...
<!-- migration_capability_research · video.signlanguageinterpreter · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.signlanguageinterpreter.v1`
...
You are **SignLanguageInterpreterAgent (VA Domain Pack)** (`video.signlanguageinterpreter`), a pack agent in the video domain swarm.
...
Design tool surface: Sign-avatar rendering (SignAll); MediaPipe pose estimation; facial-action-unit detector
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DeafCommunityReviewAgent (HiTL), LinguistAgent
- May comment on: VoiceCloneAgent (no caption), AccessibilityAgent
...
Criteria (design): Sign accuracy (Deaf-reviewer vote); facial-grammar markers
...
Execute the craft step for **SignLanguageInterpreterAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.signlanguageinterpreter`.
...
### `prompts/video.prompt.signlanguageinterpreter.v1.md`
...
Source rubric `video.rubric.signlanguageinterpreter.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.signlanguageinterpreter.v1",
  "agent_id": "video.signlanguageinterpreter",
  "title": "L2 craft rubric for SignLanguageInterpreterAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Sign accuracy (Deaf-reviewer vote)",
          "description": "Sign accuracy (Deaf-reviewer vote)",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "facial-grammar markers",
          "description": "facial-grammar markers",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Wins blind NAD-reviewer preference at scale",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Sign accuracy (Deaf-reviewer vote); facial-grammar markers",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.signlanguageinterpreter.v1.json`
...
# Source acquisition runbook — `video.signlanguageinterpreter`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.signlanguageinterpreter",
  "plan_id": "video.signlanguageinterpreter.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "owner": "video.signlanguageinterpreter",
  "cadence": "quarterly",
  "promotion_criteria": [
  ...
  "memory_namespace": "pack.video.video.signlanguageinterpreter",
  ...
  "sources": [
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "So You Want to Be an Interpreter?, 4th ed.",
      "author": "Humphrey & Alcorn",
      "isbn13": "9780964036772",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: So You Want to Be an Interpreter?, 4th ed. (Humphrey & Alcorn), ISBN-13 9780964036772"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Reading Between the Signs, 3rd ed.",
      "author": "Anna Mindess",
      "isbn13": "9781941176023",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Reading Between the Signs, 3rd ed. (Anna Mindess), ISBN-13 9781941176023"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "RID NIC curricula",
      "description": "RID NIC curricula",
    ...
    {
      "id": "src_3",
      "title": "Deaf-community consented data",
      "description": "Deaf-community consented data",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
