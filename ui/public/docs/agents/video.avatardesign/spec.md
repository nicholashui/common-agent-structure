# video.avatardesign — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.avatardesign/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.avatardesign`.
...
| **upstream_name** | AvatarDesignAgent |
| **category** | `8-AI` |
| **domain_id** | `video` |
| **previous_common_id** | `video.character_designer` |
| **status** | `registered` |
...
Host role binding: `AvatarDesignAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.avatardesign.v1`
- Rubric reference: `video.rubric.avatardesign.v1`
...
- Pack agent ID `video.avatardesign` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.character_designer` is historical mapping only.
...
# Prompt — `video.prompt.avatardesign.v1`
...
You are **AvatarDesignAgent (VA Domain Pack)** (`video.avatardesign`), a pack agent in the video domain swarm.
...
Design tool surface: HeyGen Avatar IV API; Synthesia API; C2PA signing library (c2patool); face-embedding models
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: ComplianceAgent (consent), DeepfakeDetectionAgent
- May comment on: VoiceCloneAgent (off-likeness), LipSyncAgent
...
Criteria (design): Identity-hash consistency across shots; consent chain; C2PA signed
...
Execute the craft step for **AvatarDesignAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.avatardesign`.
...
### `prompts/video.prompt.avatardesign.v1.md`
...
Source rubric `video.rubric.avatardesign.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.avatardesign.v1",
  "agent_id": "video.avatardesign",
  "title": "L2 craft rubric for AvatarDesignAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Identity-hash consistency across shots",
          "description": "Identity-hash consistency across shots",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "C2PA-verifiable + Partnership-on-AI full-pass at scale",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Identity-hash consistency across shots; consent chain; C2PA signed",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.avatardesign.v1.json`
...
# Source acquisition runbook — `video.avatardesign`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.avatardesign",
  "plan_id": "video.avatardesign.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.avatardesign",
...
### `sources/generic/video.avatardesign.SPEC.md`
...
```json
{
  ...
  "sources": [
    ...
    },
    {
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Threat Modeling (Adam Shostack), ISBN-13 9781118809990"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
  ...
  "agent_id": "video.avatardesign",
  "previous_common_agent_id": "video.character_designer",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.avatardesign",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.631432Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:27.698728+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.avatardesign",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Synthesia/HeyGen design docs",
      "description": "Synthesia/HeyGen design docs",
    ...
    {
      "id": "src_2",
      "title": "Hany Farid deepfake-detection",
      "description": "Hany Farid deepfake-detection",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
