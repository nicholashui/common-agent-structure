...
> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.sales/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.sales`.
...
| **va_id** | 111 |
| **pack_id** | `video.sales` |
| **upstream_name** | SalesAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.client_success_manager` |
| **status** | `registered` |
...
Host role binding: `SalesAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Buyer-package completeness, rights clarity, market-fit packaging

### Surpass-human signal (historical)

Produces sales-ready release packets faster than manual assembly
...
Rights systems, package builders, buyer CRM

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

ReAct over buyer package requirements
...
- Prompt reference: `video.prompt.sales.v1`
- Rubric reference: `video.rubric.sales.v1`
...
- Pack agent ID `video.sales` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.client_success_manager` is historical mapping only.
...
- Master roster row va_id=111 from embedded agents.md content above.
...
<!-- self_contained_spec · video.sales · va_id=111 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **SalesAgent** (`video.sales`, va_id=111, category `10-Sup`).
...
<!-- migration_capability_research · video.sales · v1 · 2026-07-13 -->
...
You are **SalesAgent (VA Domain Pack)** (`video.sales`), a pack agent in the video domain swarm.
...
Design tool surface: Rights systems, package builders, buyer CRM
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: ProducerAgent / EP, DistributorAgent, MarketingAgent
- May comment on: Missing buyer info, weak positioning, incomplete rights summaries
...
Criteria (design): Buyer-package completeness, rights clarity, market-fit packaging
...
Execute the craft step for **SalesAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.sales`.
...
### `prompts/video.prompt.sales.v1.md`
...
Source rubric `video.rubric.sales.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.sales.v1",
  "agent_id": "video.sales",
  "title": "L2 craft rubric for SalesAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Buyer-package completeness, rights clarity, market-fit packaging",
          "description": "Buyer-package completeness, rights clarity, market-fit packaging",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Produces sales-ready release packets faster than manual assembly",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Buyer-package completeness, rights clarity, market-fit packaging",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.sales.v1.json`
...
# Source acquisition runbook — `video.sales`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.sales",
  "plan_id": "video.sales.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "memory_namespace": "pack.video.video.sales",
...
### `sources/generic/video.comms.SPEC.md`
...
Message consistency, disclosure completeness, escalation quality

## Surpass-human signal

Produces faster aligned responses than fragmented stakeholder messaging
...
Comms calendars, approval workflows, response templates

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

## Architecture pattern

ReAct with approval chains
...
<!-- self_contained_spec · video.comms · va_id=104 -->

## Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **CommsAgent** (`video.comms`, va_id=104, category `10-Sup`).
...
<!-- migration_capability_research · video.comms · v1 · 2026-07-13 -->

### `sources/generic/video.sales.SPEC.md`
...
```json
{
  ...
  "sources": [
    {
      ...
      "citation": "EN: SPIN Selling (Neil Rackham), ISBN-13 9780070511132"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Challenger Sale (Dixon & Adamson), ISBN-13 9781591844358"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "isbn13": "9781594631900",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: To Sell Is Human (Daniel H. Pink), ISBN-13 9781594631900"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Influence, ISBN-13 9780061241895"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
  ...
  "agent_id": "video.sales",
  "previous_common_agent_id": "video.client_success_manager",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.sales",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.936778Z",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Rights windowing playbooks, market package examples, buyer materials",
      "description": "Rights windowing playbooks, market package examples, buyer materials",
