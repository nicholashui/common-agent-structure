# video.aiqaconsistency — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.aiqaconsistency/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.aiqaconsistency`.
...
| **upstream_name** | AIQAConsistencyAgent |
| **category** | `8-AI` |
| **domain_id** | `video` |
| **previous_common_id** | `video.aiqa_consistency` |
| **status** | `registered` |
...
Host role binding: `AIQAConsistencyAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.aiqaconsistency.v1`
- Rubric reference: `video.rubric.aiqaconsistency.v1`
...
- Pack agent ID `video.aiqaconsistency` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.aiqa_consistency` is historical mapping only.
...
# Prompt — `video.prompt.aiqaconsistency.v1`
...
You are **AIQAConsistencyAgent (VA Domain Pack)** (`video.aiqaconsistency`), a pack agent in the video domain swarm.
...
Design tool surface: VBench evaluation suite; hand-detector models; face-ID embedding (ArcFace); frame-diff tools
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DirectorAgent, VFXSupAgent
- May comment on: GeneratorAgent (re-roll), CompositorAgent
...
Criteria (design): Per-frame artifact score; identity-hash drift; hand/finger pass
...
Execute the craft step for **AIQAConsistencyAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.aiqaconsistency`.
...
### `prompts/video.prompt.aiqaconsistency.v1.md`
...
Source rubric `video.rubric.aiqaconsistency.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.aiqaconsistency.v1",
  "agent_id": "video.aiqaconsistency",
  "title": "L2 craft rubric for AIQAConsistencyAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Per-frame artifact score",
          "description": "Per-frame artifact score",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "identity-hash drift",
          "description": "identity-hash drift",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d3",
          "name": "hand/finger pass",
          "description": "hand/finger pass",
          "weight": 0.3334,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Catches >95% of senior QC catches + 30% missed",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Per-frame artifact score; identity-hash drift; hand/finger pass",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.aiqaconsistency.v1.json`
...
# Source acquisition runbook — `video.aiqaconsistency`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.aiqaconsistency",
  "plan_id": "video.aiqaconsistency.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3",
  ...
  "memory_namespace": "pack.video.video.aiqaconsistency",
...
### `sources/generic/video.aiqaconsistency.SPEC.md`
...
```json
{
  ...
  "agent_id": "video.aiqaconsistency",
  "previous_common_agent_id": "video.aiqa_consistency",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.aiqaconsistency",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.741722Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:27.601624+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.aiqaconsistency",
...
```json
{
  ...
  "sources": [
    ...
    {
      "id": "src_3",
      "title": "FVD literature",
      "description": "FVD literature",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_4",
      "title": "MPC/Weta QC checklists",
      "description": "MPC/Weta QC checklists",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
