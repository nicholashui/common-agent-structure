...
> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.seo/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.seo`.
...
| **va_id** | 87 |
| **pack_id** | `video.seo` |
| **upstream_name** | SEOAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.seo_metadata_specialist` |
| **status** | `registered` |
...
Host role binding: `SEOAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Keyword fit, metadata completeness, search-intent match

### Surpass-human signal (historical)

Lifts discoverability faster than manual metadata tuning
...
Keyword tools, metadata APIs, ranking dashboards

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

ReAct with search-intent validation
...
- Prompt reference: `video.prompt.seo.v1`
- Rubric reference: `video.rubric.seo.v1`
...
- Pack agent ID `video.seo` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.seo_metadata_specialist` is historical mapping only.
...
- Master roster row va_id=87 from embedded agents.md content above.
...
<!-- self_contained_spec · video.seo · va_id=87 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **SEOAgent** (`video.seo`, va_id=87, category `10-Sup`).
...
<!-- migration_capability_research · video.seo · v1 · 2026-07-13 -->
...
You are **SEOAgent (VA Domain Pack)** (`video.seo`), a pack agent in the video domain swarm.
...
Design tool surface: Keyword tools, metadata APIs, ranking dashboards
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: MarketingAgent, CopywriterAgent, AnalystAgent
- May comment on: Weak keywords, poor title-description fit, metadata omissions
...
Criteria (design): Keyword fit, metadata completeness, search-intent match
...
Execute the craft step for **SEOAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.seo`.
...
### `prompts/video.prompt.seo.v1.md`
...
Source rubric `video.rubric.seo.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.seo.v1",
  "agent_id": "video.seo",
  "title": "L2 craft rubric for SEOAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Keyword fit, metadata completeness, search-intent match",
          "description": "Keyword fit, metadata completeness, search-intent match",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Lifts discoverability faster than manual metadata tuning",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Keyword fit, metadata completeness, search-intent match",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.seo.v1.json`
...
# Source acquisition runbook — `video.seo`
...
```json
{
  ...
  "memory_namespace": "pack.video.video.seo",
...
### `sources/generic/video.seo.SPEC.md`
...
```json
{
  ...
  "agent_id": "video.seo",
  "previous_common_agent_id": "video.seo_metadata_specialist",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.seo",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.868163Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.790294+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.seo",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Search ranking studies, video metadata best practices, keyword taxonomies",
      "description": "Search ranking studies, video metadata best practices, keyword taxonomies",
