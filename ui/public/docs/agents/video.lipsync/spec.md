...
> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.lipsync/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.lipsync`.
...
|-------|-------|
| **va_id** | 99 |
| **pack_id** | `video.lipsync` |
| **upstream_name** | LipSyncAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.data_governance_officer` |
| **status** | `registered` |
...
- Pack agent ID `video.lipsync` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.data_governance_officer` is historical mapping only.
...
| 84 | **BrandAgent** | Enforces brand voice, claims boundaries, and visual consistency | Brand books, approved campaigns, legal claim guardrails, tone guides | Brand-voice similarity, policy adherence, low deviation across assets | Holds cross-channel brand consistency better than fragmented human review | CopywriterAgent, MotionGraphicsAgent, MarketingAgent, BrandStrategistAgent | Voice drift, visual inconsistency, claim creep | Brand asset library, embedding similarity, style guides | Self-Refine against brand constitution |
| 85 | **BrandStrategistAgent** | Defines audience-value framing and positioning before script and campaign execution | Positioning frameworks, campaign strategy decks, market research, brand architecture docs | Strategy coherence, differentiation strength, audience-message clarity | Produces clearer brand-to-script translation than ad hoc human handoffs | BrandAgent, ScreenwriterAgent, MarketingAgent | Positioning gaps, weak value proposition, misaligned audience framing | Research decks, messaging frameworks, strategy templates | Multi-agent debate with BrandAgent and CreativeDirectorAgent |
| 86 | **MarketingAgent** | Packages content for launch, promotions, and release sequencing | Campaign playbooks, launch calendars, media plans, asset packaging requirements | Metadata completeness, asset readiness, launch sequencing accuracy | Ships multi-channel launch packages faster than manual campaign ops | SocialMediaStrategistAgent, SEOAgent, CopywriterAgent, TrailerEditorAgent | Missing formats, weak rollout timing, incomplete promotion sets | Campaig
…
...
- Master roster row va_id=99 from embedded agents.md content above.
...
<!-- self_contained_spec · video.lipsync · va_id=99 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **LipSyncAgent** (`video.lipsync`, va_id=99, category `10-Sup`).
...
<!-- migration_capability_research · video.lipsync · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.lipsync.v1`
...
You are **LipSyncAgent (VA Domain Pack)** (`video.lipsync`), a pack agent in the video domain swarm.
...
Design tool surface: Phoneme-viseme aligners, frame-level sync tools
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: VoiceCloneAgent / LipSyncSpecialist, AnimatorAgent, AIQAConsistencyAgent
- May comment on: Mouth-shape mismatch, frame drift in dialogue, correction priority
...
Criteria (design): Sync error below threshold, correction specificity, low false positives
...
Execute the craft step for **LipSyncAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.lipsync`.
...
### `prompts/video.prompt.lipsync.v1.md`
...
Source rubric `video.rubric.lipsync.v1.json` (baseline_safe; not a production pass).
...
### `rubrics/video.rubric.lipsync.v1.json`
...
# Source acquisition runbook — `video.lipsync`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.lipsync",
  "plan_id": "video.lipsync.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "memory_namespace": "pack.video.video.lipsync",
...
### `sources/generic/video.trustsafety.SPEC.md`
...
<!-- self_contained_spec · video.trustsafety · va_id=91 -->

## Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **TrustSafetyAgent** (`video.trustsafety`, va_id=91, category `10-Sup`).
...
<!-- migration_capability_research · video.trustsafety · v1 · 2026-07-13 -->
...
```json
{
  ...
  "sources": [
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Animator's Survival Kit, Expanded",
      "author": "Richard Williams",
      "isbn13": "9780571238347",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Animator's Survival Kit, Expanded (Richard Williams), ISBN-13 9780571238347"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Illusion of Life (Thomas & Johnston), ISBN-13 9780786860708"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Timing for Animation, 2nd ed.",
      "author": "Whitaker & Halas",
      "isbn13": "9780240521602",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Timing for Animation, 2nd ed. (Whitaker & Halas), ISBN-13 9780240521602"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "isbn13": "9781879505971",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Character Animation Crash Course! (Eric Goldberg), ISBN-13 9781879505971"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Acting for Animators, 4th ed.",
      "author": "Ed Hooks",
      "isbn13": "9781138669116",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Acting for Animators, 4th ed. (Ed Hooks), ISBN-13 9781138669116"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Animator's Sketchbook",
      "author": "various; *Drawn to Life* Stanchfield",
      "isbn13": "9780240810966",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Animator's Sketchbook (various; *Drawn to Life* Stanchfield), ISBN-13 9780240810966"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "isbn13": "9781560100843",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Cartoon Animation (Preston Blair), ISBN-13 9781560100843"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
  ...
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.lipsync",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Lip-sync research, animation timing references, viseme datasets",
      "description": "Lip-sync research, animation timing references, viseme datasets",
