# video.brandstrategist — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.brandstrategist/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.brandstrategist`.
...
|-------|-------|
| **va_id** | 85 |
| **pack_id** | `video.brandstrategist` |
| **upstream_name** | BrandStrategistAgent |
| **category** | `10-Sup` |
| **domain_id** | `video` |
| **previous_common_id** | `video.content_strategist` |
| **status** | `registered` |
...
Host role binding: `BrandStrategistAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Strategy coherence, differentiation strength, audience-message clarity

### Surpass-human signal (historical)

Produces clearer brand-to-script translation than ad hoc human handoffs
...
Research decks, messaging frameworks, strategy templates

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

Multi-agent debate with BrandAgent and CreativeDirectorAgent
...
- Prompt reference: `video.prompt.brandstrategist.v1`
- Rubric reference: `video.rubric.brandstrategist.v1`
...
- Pack agent ID `video.brandstrategist` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.content_strategist` is historical mapping only.
...
- Master roster row va_id=85 from embedded agents.md content above.
...
<!-- self_contained_spec · video.brandstrategist · va_id=85 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **BrandStrategistAgent** (`video.brandstrategist`, va_id=85, category `10-Sup`).
...
# Prompt — `video.prompt.brandstrategist.v1`

> Materialized by `scripts/business/improve_agents_from_plan_v1.py` for improvement plan Wave A.
> Patterns: Multi-agent debate, Agentic Graph, Agent Skills
...
You are **BrandStrategistAgent (VA Domain Pack)** (`video.brandstrategist`), a pack agent in the video domain swarm.
...
Design tool surface: Research decks, messaging frameworks, strategy templates
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: BrandAgent, ScreenwriterAgent, MarketingAgent
- May comment on: Positioning gaps, weak value proposition, misaligned audience framing
...
Criteria (design): Strategy coherence, differentiation strength, audience-message clarity
...
Execute the craft step for **BrandStrategistAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.brandstrategist`.
...
### `prompts/video.prompt.brandstrategist.v1.md`
...
Source rubric `video.rubric.brandstrategist.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.brandstrategist.v1",
  "agent_id": "video.brandstrategist",
  "title": "L2 craft rubric for BrandStrategistAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Strategy coherence, differentiation strength, audience-message clarity",
          "description": "Strategy coherence, differentiation strength, audience-message clarity",
          "weight": 1.0,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "Produces clearer brand-to-script translation than ad hoc human handoffs",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Strategy coherence, differentiation strength, audience-message clarity",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.brandstrategist.v1.json`
...
# Source acquisition runbook — `video.brandstrategist`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.brandstrategist",
  "plan_id": "video.brandstrategist.distill.v1",
  "inputs": [
    "src_1"
  ],
  "extractors": [
  ...
  "memory_namespace": "pack.video.video.brandstrategist",
...
### `sources/generic/video.brandstrategist.SPEC.md`

Omitted here; same document as `SPEC.md` above.

### `sources/generic/video.marketing.SPEC.md`
...
| Pre-Production | StoryboardAgent + ProductionDesignAgent + CostumeAgent + ContinuityAgent | Direct
…
...
- Master roster row va_id=86 from embedded agents.md content above.
- Deep/extra text from `business/video/corpus/` and `C:\Project\va-agent-swarm`.
- Generator: `scripts/business/enrich_video_agent_specs.py`.
- Upstream project name (historical only): va-agent-swarm.


<!-- self_contained_spec · video.marketing · va_id=86 -->

## Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **MarketingAgent** (`video.marketing`, va_id=86, category `10-Sup`).
...
```json
{
  ...
  "agent_id": "video.brandstrategist",
  "previous_common_agent_id": "video.content_strategist",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.brandstrategist",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.490775Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:27.743467+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.brandstrategist",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "Positioning frameworks, campaign strategy decks, market research, brand architecture docs",
      "description": "Positioning frameworks, campaign strategy decks, market research, brand architecture docs",
