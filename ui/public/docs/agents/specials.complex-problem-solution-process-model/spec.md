# specials.complex-problem-solution-process-model — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/specials.complex-problem-solution-process-model/`.
...
- Design source (historical): `docs/special_agents_redesign/agents/complex_problem_solution_process_model.md`
- Source SHA-256: `89a4c10cd30206f2de051ba022946ebce8ef850d57f07c8af4d6cc592b7d014e`
...
```json
{
  ...
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\specials\\agents\\specials.complex-problem-solution-process-model",
