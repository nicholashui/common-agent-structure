...
> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.finance/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.finance`.
...
|-------|-------|
| **va_id** | 38 |
| **pack_id** | `video.finance` |
| **upstream_name** | FinanceAgent |
| **category** | `7-Edu` |
| **domain_id** | `video` |
| **previous_common_id** | `video.budget_controller` |
| **status** | `registered` |
...
Host role binding: `FinanceAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Numerical accuracy 100%; SEC compliance

### Surpass-human signal (historical)

Passes CFA L3; lower retraction rate than analyst desks
...
Bloomberg API; EDGAR/SEC filings; financial-calc validators

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

ReAct (fetch data → validate → compose)
...
- Prompt reference: `video.prompt.finance.v1`
- Rubric reference: `video.rubric.finance.v1`
...
- Pack agent ID `video.finance` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.budget_controller` is historical mapping only.
...
| 77 | **ROASOptimizerAgent** | Optimizes ad creatives for performance metrics | Meta Marketing Science, TikTok Ads Academy, MMM/MTA literature | ROAS uplift vs control; significance ≥95% | Beats senior performance marketer at equal budget | PerformanceMarketerAgent, AnalystAgent | UGCAgent (low hoo
…
...
| 29 | **Copywriter** | Scripts, captions, hooks, headlines | Conciseness, voice, persuasion | Agency copy 3–8 yrs; portfolio school (Miami Ad School, VCU Brandcenter) | Ads, social posts, hooks, founder stories | David Ogilvy (*Ogilvy on Advertising*), Joanna Wiebe (Copy
…
...
| # | Agent | Responsibility | Knowledge Distillation Source | Self-Quality Criteria | Surpass-Human Signal | Accepts Critique From | Comments On | Tool Access | Architecture Pattern |
|---|---|---|---|---|---|---|---|---|---|
| 73 | **PromptOptimizerAgent** | Auto-improves prompts via OPRO/APE/DSPy/Promptbreeder | OPRO (Yang 2023); APE (Zhou 2022); DSPy (Stanford); Promptbreeder (DeepM
…
...
<!-- self_contained_spec · video.finance · va_id=38 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **FinanceAgent** (`video.finance`, va_id=38, category `7-Edu`).
...
<!-- migration_capability_research · video.finance · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.finance.v1`
...
You are **FinanceAgent (VA Domain Pack)** (`video.finance`), a pack agent in the video domain swarm.
...
Design tool surface: Bloomberg API; EDGAR/SEC filings; financial-calc validators
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: SMEAgent (econ), ComplianceAgent
- May comment on: ScriptwriterAgent (number drift), MotionGraphicsAgent (chart scale)
...
Criteria (design): Numerical accuracy 100%; SEC compliance
...
Execute the craft step for **FinanceAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.finance`.
...
### `prompts/video.prompt.finance.v1.md`
...
Source rubric `video.rubric.finance.v1.json` (baseline_safe; not a production pass).
...
### `rubrics/video.rubric.finance.v1.json`
...
# Source acquisition runbook — `video.finance`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.finance",
  "plan_id": "video.finance.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "memory_namespace": "pack.video.video.finance",
...
### `sources/generic/video.costoptimizer.SPEC.md`
...
### `sources/generic/video.finance.SPEC.md`
...
```json
{
  ...
  "sources": [
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Intelligent Investor, Rev.",
      "author": "Benjamin Graham",
      "isbn13": "9780060555665",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Intelligent Investor, Rev. (Benjamin Graham), ISBN-13 9780060555665"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Security Analysis, 6th ed. (Graham & Dodd), ISBN-13 9780071592536"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Valuation, 7th ed.",
      "author": "Koller, Goedhart, Wessels",
      "isbn13": "9781119610885",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Valuation, 7th ed. (Koller, Goedhart, Wessels), ISBN-13 9781119610885"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: A Random Walk Down Wall Street (Burton Malkiel), ISBN-13 9780393358384"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Options, Futures, and Other Derivatives, 10th ed.",
      "author": "John Hull",
      "isbn13": "9780134472089",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Options, Futures, and Other Derivatives, 10th ed. (John Hull), ISBN-13 9780134472089"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
      "title": "聪明的投资者",
      "isbn13": "9787111403012",
      "origin": "spec/book_of_knowledge.md",
      "citation": "ZH: 聪明的投资者，ISBN-13 9787111403012"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
      "title": "证券分析",
      "isbn13": "9787111403029",
      "origin": "spec/book_of_knowledge.md",
      "citation": "ZH: 证券分析，ISBN-13 9787111403029"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "ZH: 价值评估，ISBN-13 9787508637020"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
      ...
      "origin": "spec/book_of_knowledge.md",
      "citation": "ZH: 漫步华尔街，ISBN-13 9787508640114"
    },
    {
      "kind": "reference_book",
      "language": "EN",
    ...
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Movie Business Book",
      "author": "Jason E. Squire",
      "isbn13": "9780743293402",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Movie Business Book (Jason E. Squire), ISBN-13 9780743293402"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      ...
      "isbn13": "9781315670089",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Filmmakers and Financing (Louise Levison), ISBN-13 9781315670089"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "The Producers Business Handbook The Roadmap for the Balanced Film Producer",
      "author": "John J. Lee, Jr. Anne Marie Gillen",
      "isbn13": "9781138050938",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: The Producers Business Handbook The Roadmap for the Balanced Film Producer (John J. Lee, Jr. Anne Marie Gillen), ISBN-13 9781138050938"
    },
    {
      "kind": "reference_book",
      "language": "EN",
    ...
    },
    {
      ...
      "author": "Akidau, TylerChernyak, SlavaLax, Reuven",
      "isbn13": "9781491983874",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Streaming systems the what, where, when, and how of large-scale data processing (Akidau, TylerChernyak, SlavaLax, Reuven), ISBN-13 9781491983874"
    },
    {
      "kind": "reference_book",
      "language": "EN",
  ...
  "agent_id": "video.finance",
  "previous_common_agent_id": "video.budget_controller",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.finance",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.957113Z",
  "generic_source_depth": {
    "excerpts": true,
    "study": true,
    "adopted_at": "2026-07-27T01:30:28.184547+00:00",
    "upstream": "generic-swarm-ops/business/video/agents"
  },
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\video\\agents\\video.finance",
...
```json
{
  ...
  "sources": [
    {
      "id": "src_1",
      "title": "CFA curriculum",
      "description": "CFA curriculum",
    ...
    },
    {
      ...
      "description": "SEC marketing rule",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_3",
      "title": "Bloomberg/Refinitiv feeds",
      "description": "Bloomberg/Refinitiv feeds",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
