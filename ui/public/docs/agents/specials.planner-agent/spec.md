# specials.planner-agent — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/specials.planner-agent/`.
...
- Source SHA-256: `8b69afb197418ecd41f2af3e502afa70e0b77a355dd511eeffc60151fd01af79`
...
```json
{
  ...
  "imported_from": "C:\\Project\\common-agent-swarm-ops\\business\\specials\\agents\\specials.planner-agent",
