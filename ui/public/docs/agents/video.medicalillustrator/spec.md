# video.medicalillustrator — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.medicalillustrator/`.
...
# MedicalIllustratorAgent

> Self-contained VA Domain Pack agent on host common-agent-swarm-ops.
> Pack agent ID matches pure VA/generic taxonomy: `video.medicalillustrator`.
...
|-------|-------|
| **va_id** | 35 |
| **pack_id** | `video.medicalillustrator` |
| **upstream_name** | MedicalIllustratorAgent |
| **category** | `7-Edu` |
| **domain_id** | `video` |
| **previous_common_id** | `video.risk_manager` |
| **status** | `registered` |
...
Host role binding: `MedicalIllustratorAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
Anatomical accuracy (detection model); AMI rubric

### Surpass-human signal (historical)

CMI peers vote ≥pass in blind review
...
Anatomage 3D API; DALL-E 3 (medical-prompt mode); anatomy-detection model

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

### Architecture pattern (historical)

Self-Refine (rubric: AMI scoring criteria)
...
- Prompt reference: `video.prompt.medicalillustrator.v1`
- Rubric reference: `video.rubric.medicalillustrator.v1`
...
- Pack agent ID `video.medicalillustrator` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.risk_manager` is historical mapping only.
...
- Master roster row va_id=35 from embedded agents.md content above.
...
<!-- self_contained_spec · video.medicalillustrator · va_id=35 -->

Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **MedicalIllustratorAgent** (`video.medicalillustrator`, va_id=35, category `7-Edu`).
...
<!-- migration_capability_research · video.medicalillustrator · v1 · 2026-07-13 -->
...
# Prompt — `video.prompt.medicalillustrator.v1`
...
You are **MedicalIllustratorAgent (VA Domain Pack)** (`video.medicalillustrator`), a pack agent in the video domain swarm.
...
Primary distillation sources (design): Netter atlas; AMI/CMI curriculum; Anatomage

## Developer

### Tools (allowlist intent)
Design tool surface: Anatomage 3D API; DALL-E 3 (medical-prompt mode); anatomy-detection model
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: SMEAgent (physician), AccessibilityAgent
- May comment on: AnimatorAgent (wrong anatomy), CopywriterAgent (mis-term)
...
Criteria (design): Anatomical accuracy (detection model); AMI rubric
...
Execute the craft step for **MedicalIllustratorAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.medicalillustrator`.
...
### `prompts/video.prompt.medicalillustrator.v1.md`
...
Source rubric `video.rubric.medicalillustrator.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.medicalillustrator.v1",
  "agent_id": "video.medicalillustrator",
  "title": "L2 craft rubric for MedicalIllustratorAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Anatomical accuracy (detection model)",
          "description": "Anatomical accuracy (detection model)",
          "weight": 0.5,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
    ...
    "L3_preference": {
      ...
      "surpass_signal_design": "CMI peers vote ≥pass in blind review",
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Anatomical accuracy (detection model); AMI rubric",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.medicalillustrator.v1.json`
...
# Source acquisition runbook — `video.medicalillustrator`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.medicalillustrator",
  "plan_id": "video.medicalillustrator.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3"
  ...
  "owner": "video.medicalillustrator",
  "cadence": "quarterly",
  "promotion_criteria": [
  ...
  "memory_namespace": "pack.video.video.medicalillustrator",
...
### `sources/generic/video.ethics.SPEC.md`
...
Ethical issue recall, mitigation clarity, escalation precision

## Surpass-human signal

Surfaces release risks earlier than reactive ethics review
...
Ethics review templates, risk matrices, disclosure checklists

**Runtime safety:** Host allow-lists are only `agent_spec.json` + `tool-permission-register.json`. CI uses video_* stubs. Do not treat design-time vendor names as enabled APIs.

## Architecture pattern

Multi-agent debate + constitutional review
...
|---|---|---|---|---|---|---|---|---|---|
| 81 | **AnalystAgent** | Aggregates business, creative, and technical performance telemetry into decision-ready reports | Platform analytics dashboards; experiment logs; evaluation-harness outputs; benchmark histories | KPI completeness; forecast-vs-actual variance within tolerance; insight-to-action turnaround | Detects actionable performance shifts faster than human analyst rotations | SocialMediaStrategistAgent, PerformanceMarketerAgent, EvaluationHarnessAgent | Campaign pacing, release timing, retention and ROAS anomalies | YouTube Analytics, Meta/TikTok Ads dashboards, BI warehouse, benchmark logs | ReAct over telemetry + regression analysis |
| 82 | **AudienceSimAgent** | Simulates audience preference, engagement, and drop-off | Pairwise preference datasets; retention studies; audience segmentation models | Preference stability across cohorts; retention-prediction accuracy; disagreement logging | Predicts audience reaction earlier than conventional test-screen cycles | DirectorAgent, EditorAgent, AnalystAgent, JudgeAgent | Hooks, pacing, clarity, emotional fit, trailer strength | Persona simulators, pairwise evaluation harness, retention models | LLM-as-Judge + pairwi
…
...
<!-- self_contained_spec · video.ethics · va_id=107 -->

## Migration capability research (v1 honest · 2026-07-13)

Role-specific capability research for **EthicsAgent** (`video.ethics`, va_id=107, category `10-Sup`).
...
<!-- migration_capability_research · video.ethics · v1 · 2026-07-13 -->
...
```json
{
  ...
  "sources": [
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Atlas of Human Anatomy, 7th ed.",
      "author": "Frank H. Netter",
      "isbn13": "9780323393225",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Atlas of Human Anatomy, 7th ed. (Frank H. Netter), ISBN-13 9780323393225"
    },
    {
      "kind": "reference_book",
      "language": "EN",
      "title": "Grant's Atlas of Anatomy, 14th ed.",
      "isbn13": "9781496310248",
      "origin": "spec/book_of_knowledge.md",
      "citation": "EN: Grant's Atlas of Anatomy, 14th ed., ISBN-13 9781496310248"
    },
    {
      "kind": "reference_book",
      "language": "ZH",
  ...
  "agent_id": "video.medicalillustrator",
  "previous_common_agent_id": "video.risk_manager",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.medicalillustrator",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:11.227971Z",
...
```json
{
  ...
  "sources": [
    ...
    {
      "id": "src_2",
      "title": "AMI/CMI curriculum",
      "description": "AMI/CMI curriculum",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
