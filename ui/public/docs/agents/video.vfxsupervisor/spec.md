# video.vfxsupervisor — Spec

> Merged for Help from `SPEC.md`, `agent_spec.json`, `prompts/`, `rubrics/`, and `sources/` in `agents/video.vfxsupervisor/`.
...
> Pack agent ID matches pure VA/generic taxonomy: `video.vfxsupervisor`.
...
| **upstream_name** | VFXSupervisorAgent |
| **category** | `3-Edit` |
| **domain_id** | `video` |
| **previous_common_id** | `video.vfx_supervisor` |
| **status** | `registered` |
...
Host role binding: `VFXSupervisorAgent (VA Domain Pack)`. Design-time VA table content below is historical and non-binding for activation.
...
- Prompt reference: `video.prompt.vfxsupervisor.v1`
- Rubric reference: `video.rubric.vfxsupervisor.v1`
...
- Pack agent ID `video.vfxsupervisor` is aligned to pure VA Domain Pack / generic pack taxonomy (Agent IDs ≈ VA tables).
- Previous common inventory ID `video.vfx_supervisor` is historical mapping only.
...
You are **VFXSupervisorAgent (VA Domain Pack)** (`video.vfxsupervisor`), a pack agent in the video domain swarm.
...
Design tool surface: Nuke via MCP bridge; Runway Gen-4 Aleph (video-to-video); ComfyUI
Runtime: only host-registered `allowed_tools` from agent_spec.json. Never invent credentials.

### Collaboration
- Accepts critique from: DirectorAgent, DoPAgent, ConsistencyAgent
- May comment on: AIGeneratorAgent (artifacts), CompositorAgent
...
Criteria (design): Shot-completion %; comp-error pixel count; CLIP-T vs plate
...
Execute the craft step for **VFXSupervisorAgent (VA Domain Pack)**. Use the architecture pattern above (reason → optional tool calls → self-review → emit).
...
> Derived from `ui/RETHINK_100_IMPROVEMENTS.md` for `video.vfxsupervisor`.
...
### `prompts/video.prompt.vfxsupervisor.v1.md`
...
Source rubric `video.rubric.vfxsupervisor.v1.json` (baseline_safe; not a production pass).

```json
{
  "schema_version": "1.0",
  "rubric_id": "video.rubric.vfxsupervisor.v1",
  "agent_id": "video.vfxsupervisor",
  "title": "L2 craft rubric for VFXSupervisorAgent",
  "pass_threshold": 85,
  "max_score": 100,
  "layers": {
    "L1_spec": {
    ...
    "L2_rubric": {
      ...
      "dimensions": [
        {
          "id": "d1",
          "name": "Shot-completion %",
          "description": "Shot-completion %",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
        ...
        {
          "id": "d2",
          "name": "comp-error pixel count",
          "description": "comp-error pixel count",
          "weight": 0.3333,
          "threshold_hint": null,
          "score_min": 0,
          "score_max": 100
  ...
  "sources": {
    "agents_md_self_quality_criteria": "Shot-completion %; comp-error pixel count; CLIP-T vs plate",
    "research": [
      "LLM-as-Judge",
      "Self-Refine",
      "Constitutional AI"
...
### `rubrics/video.rubric.vfxsupervisor.v1.json`
...
# Source acquisition runbook — `video.vfxsupervisor`
...
```json
{
  "schema_version": "1.0",
  "agent_id": "video.vfxsupervisor",
  "plan_id": "video.vfxsupervisor.distill.v1",
  "inputs": [
    "src_1",
    "src_2",
    "src_3",
  ...
  "memory_namespace": "pack.video.video.vfxsupervisor",
...
```json
{
  ...
  "agent_id": "video.vfxsupervisor",
  "previous_common_agent_id": "video.vfx_supervisor",
  "va_taxonomy_aligned": true,
  "generic_source": "generic-swarm-ops/business/video/agents/video.vfxsupervisor",
  "note": "Imported into CASOPS as baseline_safe. No production activation, no network, no plugins, memory writes forbidden.",
  "aligned_at": "2026-07-27T00:48:10.699208Z",
...
```json
{
  ...
  "sources": [
    ...
    {
      "id": "src_2",
      "title": "SIGGRAPH papers",
      "description": "SIGGRAPH papers",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
    ...
    {
      "id": "src_3",
      "title": "Weta/DNEG talks",
      "description": "Weta/DNEG talks",
      "license_class": "unknown_review_required",
      "acquisition_method": "manual_or_licensed_api",
      "local_path_hint": "sources/excerpts/ or sources/study/",
      "refresh_sla_days": 90,
