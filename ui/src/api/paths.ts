...
export const CLIENT_BINDINGS = {
  ...
  listPrograms: ["GET", "/api/v3/programs"],
  createProgram: ["POST", "/api/v3/programs"],
  getProgram: ["GET", "/api/v3/programs/{program_id}"],
  saveProgram: ["PUT", "/api/v3/programs/{program_id}"],
  spawnProgram: ["POST", "/api/v3/programs/{program_id}/spawn"],
  finishProgram: ["POST", "/api/v3/programs/{program_id}/finish"],
  listProgramComms: ["GET", "/api/v3/programs/{program_id}/comms"],
  stampProgramComms: ["POST", "/api/v3/programs/{program_id}/comms"],
  getProgramSequence: ["GET", "/api/v3/programs/{program_id}/sequence"],
