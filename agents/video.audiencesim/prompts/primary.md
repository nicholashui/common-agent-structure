...
### How to reply (Chat)
1. Own only: Owns simulated viewer segments and predicted friction, not the cut. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Katz, Blumler, Gurevitch — uses and gratifications); do not invent measurements.
