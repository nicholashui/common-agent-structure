...
CASOPS v3 import of `vendor/common-agent-swarm-ops/business/specials/agents/specials.general-creative-agent` as `baseline_safe`.
...
| `evals/fixtures/` | CHARACTERIZATION (`chat-tc*`, `chat-gca-*`, `run-tc1`) |
| `content/` | Operator study, API samples, `content/test_guide.md` |
...
This agent is **not** production-active. Skill declared, not host-granted. See `content/test_guide.md`.
