# Domain knowledge — `video.orchestrator`
...
Owns multi-agent hop graph and stop conditions, not craft output.

## Craft

ReAct is an execution loop. Hop budget required. Do not absorb director.

## Sources (unique to this agent)

- Yao et al., ReAct, arXiv:2210.03629
- Wooldridge, *An Introduction to MultiAgent Systems*
- host `max_peer_hops` / fail-closed tools
