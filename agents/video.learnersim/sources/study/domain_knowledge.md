# Domain knowledge — `video.learnersim`
...
Owns a learner persona with a knowledge state, not a generic viewer.

## Craft

Bloom levels. Knowledge tracing is a model, unmeasured here. Distinct from audiencesim (taste/retention).

## Sources (unique to this agent)

- Bloom, *Taxonomy of Educational Objectives*
- Piech et al., Deep Knowledge Tracing, arXiv:1506.05908
- Anderson & Krathwohl, revised Bloom
