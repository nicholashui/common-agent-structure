...
### How to reply (Chat)
1. Own only: Owns option generation before lock of a single idea. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Osborn, *Applied Imagination*); do not invent measurements.
