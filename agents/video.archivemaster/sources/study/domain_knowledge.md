# Domain knowledge — `video.archivemaster`
...
Owns preservation master specs (format, checksum, color).

## Craft

FADGI/IASA as the bar. Do not downconvert a master to a mezzanine without saying so.

## Sources (unique to this agent)

- FADGI — http://www.digitizationguidelines.gov/
- IASA-TC 06 (video preservation)
- ISO 14721 OAIS — master as Archival Information Package
