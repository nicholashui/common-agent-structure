...
Owns brand system (identity, promise), not a single campaign idea.

## Craft

CBBE: salience → meaning → response → resonance. Distinct from creativedirector.

## Sources (unique to this agent)

- Aaker, *Building Strong Brands*
- Keller, *Strategic Brand Management* (CBBE)
...
- [How to modify your site name in Google Search](https://www.youtube.com/watch?v=DPJ0AzJSlFE)
