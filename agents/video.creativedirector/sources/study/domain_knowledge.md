# Domain knowledge — `video.creativedirector`
...
Owns campaign idea and brand-story lock, not DoP lighting.

## Craft

Idea must survive three placements (hero, cutdown, still). Distinct from `video.director` shot intent.

## Sources (unique to this agent)

- Aaker, *Building Strong Brands*
- Ries & Trout, *Positioning*
- Barry, *The Advertising Concept Book*
