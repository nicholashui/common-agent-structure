# Domain knowledge — `video.casting`
...
Brief: age band, language, union, availability. Likeness escalates to legal.

## Sources (unique to this agent)

- SAG-AFTRA contracts (design) — https://www.sagaftra.org
- Honthaner, *Complete Film Production Handbook* — casting
- Breakdown / sides as the artifact, not a tool grant
...
- [Big Five traits — not a diagnosis](https://www.youtube.com/watch?v=oWpRKJPCI7M)

### xAI (non-activating vendor docs)
- [Imagine likeness risks; no live generation](https://x.ai/docs/guides/image-generations)
