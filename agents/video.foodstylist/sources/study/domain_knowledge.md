# Domain knowledge — `video.foodstylist`
...
Owns food appearance for camera, not recipe IP.

## Craft

Advertising food must not become an undeclared health claim. Continuity of garnish.

## Sources (unique to this agent)

- Bellingham & Bybee, *Food Styling for Photographers*
- FDA/FTC food advertising truth-in-advertising (design)
- Young, *The Photographer’s Guide to Food Styling* (craft)
...
- [Think like a cinematographer](https://www.youtube.com/watch?v=wfns4DuEB5M)

### xAI (non-activating vendor docs)
- [Imagine image/video — design-time only](https://x.ai/docs/guides/image-generations)
