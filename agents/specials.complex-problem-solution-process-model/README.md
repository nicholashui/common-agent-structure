...
CASOPS v3 import of `vendor/common-agent-swarm-ops/business/specials/agents/specials.complex-problem-solution-process-model` as `baseline_safe`.
...
Operator study and three-tier tests: `content/test_guide.md`. Skill `casops.skill.complex.cynefin-stage` declared, not host-granted.
