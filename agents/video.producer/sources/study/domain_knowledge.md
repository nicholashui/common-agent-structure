# Domain knowledge — `video.producer`
...
Owns schedule, budget, logistics — not shot intent.

## Craft

Producer vs director (DGA). Call sheet is the artifact.

## Sources (unique to this agent)

- Honthaner, *The Complete Film Production Handbook*
- DGA / PGA role definitions (design)
- Clevé, *Film Production Management*
...
- [Crash Course Film Production, What producers do (Lily Gladstone)](https://www.youtube.com/watch?v=zU_1ClPIOAg)
