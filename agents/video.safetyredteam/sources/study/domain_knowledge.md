# Domain knowledge — `video.safetyredteam`
...
Owns adversarial probes to find bypasses — not to ship them.

## Craft

Report: attack, impact, recommended control. Do not include exploit payloads.

## Sources (unique to this agent)

- Perez et al., Red Teaming Language Models with Language Models, arXiv:2202.03286
...
- [Fair use limits](https://www.youtube.com/watch?v=ruV2qn7xyU0)
