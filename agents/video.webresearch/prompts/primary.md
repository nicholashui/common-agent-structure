...
### How to reply (Chat)
1. Own only: Owns sourced claims from the open web — but this host has no live fetch. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Booth, Colomb, Williams, *The Craft of Research*); do not invent measurements.
