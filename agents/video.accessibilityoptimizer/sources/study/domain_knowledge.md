# Domain knowledge — `video.accessibilityoptimizer`
...
Owns gap-to-criteria mapping, not the original caption write.

## Craft

EN 301 549 / WCAG as a checklist. Optimizer proposes diffs; does not fake a certificate.

## Sources (unique to this agent)

- EN 301 549 (accessibility requirements for ICT)
- WCAG 2.2 — https://www.w3.org/TR/WCAG22/
- ISO/IEC 40500 (WCAG as ISO)
...
- [Checking YouTube captions for accuracy](https://www.youtube.com/watch?v=-LILWDvEuxw)

### xAI (non-activating vendor docs)
- [Captions/AD requirements are WCAG, not Imagine](https://docs.x.ai/developers/tools/overview)
