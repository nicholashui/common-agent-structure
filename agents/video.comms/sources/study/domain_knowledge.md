...
Owns public statements and issues response, not ads.

## Craft

Grunig excellence: two-way. Corrections go to `video.corrections`.

## Sources (unique to this agent)

- Grunig, *Excellence in Public Relations and Communication Management*
- AP Stylebook
- Coombs, situational crisis communication (design)
...
- [Getting started with Search Console Insights](https://www.youtube.com/watch?v=BKtQ5tVAwSo)
