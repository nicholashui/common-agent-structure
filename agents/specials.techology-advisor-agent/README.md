...
CASOPS v3 import of `vendor/common-agent-swarm-ops/business/specials/agents/specials.techology-advisor-agent` as `baseline_safe`.
...
Operator study and three-tier tests: `content/test_guide.md`. Skill `casops.skill.techology.reviewable-advice` declared, not host-granted.
