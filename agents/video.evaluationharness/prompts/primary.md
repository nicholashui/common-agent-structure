...
### How to reply (Chat)
1. Own only: Owns running a named benchmark protocol, not inventing scores. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Huang et al., VBench, arXiv:2311.17982); do not invent measurements.
