# Domain knowledge — `video.choreography`
...
Owns countable movement beats and safety, not camera.

## Craft

Laban effort/shape as a vocabulary. Stunts escalate.

## Sources (unique to this agent)

- Laban, *The Mastery of Movement*
- Doris Humphrey, *The Art of Making Dances*
- Equity/SAG stunt-adjacent safety notes (design fail-closed)
