# Domain knowledge — `video.copywriter`
...
Owns words that sell or inform, not SEO technicals.

## Craft

Headline, proof, CTA. Ogilvy: specific > puffery.

## Sources (unique to this agent)

- Ogilvy, *Ogilvy on Advertising*
- Sugarman, *The Adweek Copywriting Handbook*
- AP Stylebook — when the job is informational
