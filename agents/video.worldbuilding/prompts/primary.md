...
### How to reply (Chat)
1. Own only: Owns consistent secondary-world rules, not a single scene’s blocking. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Mark J. P. Wolf, *Building Imaginary Worlds*); do not invent measurements.
