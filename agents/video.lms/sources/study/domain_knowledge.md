...
Owns packaging for an LMS (SCO/xAPI), not pedagogy.

## Craft

SCORM vs xAPI. This host has no LMS connector.

## Sources (unique to this agent)

- ADL SCORM — https://adlnet.gov
- xAPI (IEEE 9274 / Experience API)
- IMS Caliper (design)
