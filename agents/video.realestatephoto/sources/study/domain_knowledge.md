# Domain knowledge — `video.realestatephoto`
...
Owns accurate property depiction, not travel cine.

## Craft

NAR: no deceptive HDR that invents rooms. MLS photo rules as design.

## Sources (unique to this agent)

- NAR Code of Ethics — https://www.nar.realtor
- MLS photo representation rules (design, vary by board)
- HDR bracketing as technique, not a tool grant
