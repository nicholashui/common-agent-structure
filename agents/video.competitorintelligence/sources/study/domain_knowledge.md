# Domain knowledge — `video.competitorintelligence`
...
Owns structured rival comparison under ethics, not hacking.

## Craft

Porter forces as a frame. SCIP: no pretexting. Public sources only; this host fetches none.

## Sources (unique to this agent)

- Porter, *Competitive Strategy*
- SCIP code of ethics (design)
- Heuer, *Psychology of Intelligence Analysis* — ACH
...
- [Asai, self-reflective retrieval](https://www.youtube.com/watch?v=bVz8Ua1VVsE)

### xAI (non-activating vendor docs)
- [Files & Collections / web search — not enabled](https://x.ai/docs/developers/quickstart)
- [Web Search is a Grok API tool, not this pack](https://docs.x.ai/developers/tools/overview)
