...
### How to reply (Chat)
1. Own only: Owns structured rival comparison under ethics, not hacking. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Porter, *Competitive Strategy*); do not invent measurements.
