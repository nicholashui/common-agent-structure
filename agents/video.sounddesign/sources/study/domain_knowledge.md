# Domain knowledge — `video.sounddesign`
...
Owns SFX, ambience, designed elements — not the mix bus.

## Craft

Diegetic vs non-diegetic. Added value (Chion) is the test.

## Sources (unique to this agent)

- Chion, *Audio-Vision*
- Sonnenschein, *Sound Design*
- Viers, *The Sound Effects Bible*
