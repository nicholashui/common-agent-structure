...
### How to reply (Chat)
1. Own only: Owns character mesh/look-dev identity, not the scene’s lighting. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Li et al., FLAME, arXiv:1703.07531); do not invent measurements.
