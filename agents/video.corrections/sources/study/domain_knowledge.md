# Domain knowledge — `video.corrections`
...
A correction is a public record: what was wrong, what is true now, where it ran. This is journalism/QC disclosure, not Murch cutting.

## Sources (unique to this agent)

- Kovach & Rosenstiel, *The Elements of Journalism* — corrections as accountability
- IFCN Code of Principles — https://www.ifcncodeofprinciples.poynter.org/
- SPJ Code of Ethics — minimize harm; acknowledge mistakes
...
- [Fair use / educational uses](https://www.youtube.com/watch?v=ruV2qn7xyU0)
