# Domain knowledge — `video.performancemarketer`
...
Owns paid performance hypotheses and incrementality, not brand identity.

## Craft

Last-click is not causal. Name the attribution window.

## Sources (unique to this agent)

- Farris et al., *Marketing Metrics*
- Google Ads measurement / incrementality docs (design) — https://support.google.com/google-ads
...
- [Rewriting the SEO Starter Guide (Search Off the Record)](https://www.youtube.com/watch?v=EABqJXHQB3w)
