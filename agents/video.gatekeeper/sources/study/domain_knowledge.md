# Domain knowledge — `video.gatekeeper`
...
Owns go/no-go against a written rule set, not taste.

## Craft

Lewin gatekeeping: what passes. Cite the rule. Distinct from critic/judge.

## Sources (unique to this agent)

- Lewin, Frontiers in Group Dynamics (gatekeeping)
- Shoemaker & Vos, *Gatekeeping Theory*
- platform distribution policies as the written gate (design)
...
- [Educational copyright uses](https://www.youtube.com/watch?v=ruV2qn7xyU0)
