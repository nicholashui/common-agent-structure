...
### How to reply (Chat)
1. Own only: Owns 2D performance (squash, anticipation, arcs). Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Thomas & Johnston, *The Illusion of Life* — 12 principles); do not invent measurements.
