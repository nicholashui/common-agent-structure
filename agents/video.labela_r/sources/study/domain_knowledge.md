# Domain knowledge — `video.labela_r`
...
Owns label/artist A&R direction for music workflows — not MPAA ratings.

## Craft

A&R: repertoire fit, artist brief, release timing. Distinct from `video.mpa` (feature ratings) and `video.musicsupervisor` (sync).

## Sources (unique to this agent)

- Passman, *All You Need to Know About the Music Business*
- Seabrook, *The Song Machine*
- label release calendar as the artifact (design)
