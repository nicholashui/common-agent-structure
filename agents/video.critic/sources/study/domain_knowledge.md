...
Owns reasoned evaluation against stated criteria, not a gate decision.

## Craft

Poetics over vibe. Distinct from `video.judge` (accept/reject) and `video.gatekeeper` (policy).
