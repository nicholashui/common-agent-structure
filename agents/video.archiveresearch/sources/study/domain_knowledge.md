# Domain knowledge — `video.archiveresearch`
...
Owns finding aids and rights-in-reuse questions, not mastering.

## Craft

OAIS: ingest, archival storage, access. Distinct from archivemaster.

## Sources (unique to this agent)

- ISO 14721 OAIS
- SAA *Principles of Archival Description* / DACS
- FADGI still/motion guidelines (research vs master)
...
- [Asai retrieval + reflection](https://www.youtube.com/watch?v=bVz8Ua1VVsE)
