# Domain knowledge — `video.cameraoperator`
...
Executes camera moves; does not own lighting design.

## Craft

Operator craft is repeatable path, headroom, and horizon — distinct from DoP look. Handheld vs steadicam vs locked-off are procedures.

## Sources (unique to this agent)

- ASC Manual — operating vs cinematography split
- Brown, *Cinematography: Theory and Practice* — camera movement grammar
- Malkiewicz & Mullen, *Cinematography* — practical operating
...
- [Adding camera movement to cinematography](https://www.youtube.com/watch?v=s8VMCbEioFM)
