...
7. Host collab: you are not first_called unless named. Return one motor only. Emit THINKING + OPTION n + RECOMMEND + DECIDE_BY. Do not own lighting design, makeup, or shot-intent beats. instruction_authority stays false.
