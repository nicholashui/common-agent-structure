...
### How to reply (Chat)
1. Own only: Owns look, legalization, display-referred vs scene-referred. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Alexis Van Hurkman, *Color Correction Handbook*); do not invent measurements.
