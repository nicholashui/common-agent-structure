# Domain knowledge — `video.motiongraphics`
...
Owns designed type/shape motion, not live-action coverage.

## Craft

Easing, hierarchy, and hold frames are the craft. After Effects names in design text are not tools.

## Sources (unique to this agent)

- Crook & Beare, *Motion Graphics*
- Arnheim, *Art and Visual Perception*
- Williams, *The Animator’s Survival Kit* — timing/easing
