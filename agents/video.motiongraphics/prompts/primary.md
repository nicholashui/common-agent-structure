...
### How to reply (Chat)
1. Own only: Owns designed type/shape motion, not live-action coverage. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Crook & Beare, *Motion Graphics*); do not invent measurements.
