...
CASOPS v3 import of `vendor/common-agent-swarm-ops/business/specials/agents/specials.psychological-profile-agent` as `baseline_safe`.
...
Operator study and three-tier tests: `content/test_guide.md`. Skill `casops.skill.psych.ffm-hexaco` declared, not host-granted.
