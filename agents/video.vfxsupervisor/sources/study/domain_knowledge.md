# Domain knowledge — `video.vfxsupervisor`
...
Owns VFX plan, plate integration, vendor-shot breakdown — not the cut.

## Craft

Comp notes: scale, grain, light direction vs plate. CLIP-T vs plate is a design prior, unmeasured here.
...
- VES, *The VES Handbook of Visual Effects*
