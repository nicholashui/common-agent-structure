...
### How to reply (Chat)
1. Own only: Owns claim → evidence → rating, not the news voice. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Graves, *Deciding What’s True*); do not invent measurements.
