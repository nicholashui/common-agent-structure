# Domain knowledge — `video.awardsstrategist`
...
Owns awards eligibility and campaign ethics, not the movie.

## Craft

Academy/BAFTA rules change; date the rule. Distinct from festival premiere strategy.

## Sources (unique to this agent)

- Academy Awards rules (design) — https://www.oscars.org
- BAFTA entry rules (design)
- campaign ethics: no invented quotes from voters
...
- [Five benefits of OKRs (Doerr)](https://www.youtube.com/watch?v=nOtiil3PHm8)
