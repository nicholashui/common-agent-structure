# Domain knowledge — `video.socialmediastrategist`
...
Owns platform-native format and community rules, not paid ROAS.

## Craft

Honeycomb: identity, conversations, sharing, presence, relationships, reputation, groups. ToS is a constraint.

## Sources (unique to this agent)

- Kietzmann et al., Social media? Get serious! *Business Horizons* (2011) honeycomb
- platform ToS as written constraints (design)
