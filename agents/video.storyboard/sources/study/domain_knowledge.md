# Domain knowledge — `video.storyboard`
...
Owns shot-by-shot drawings as a contract for camera/edit.

## Craft

Each panel: size, angle, move, who looks. Boards are not concept art mood.

## Sources (unique to this agent)

- Katz, *Film Directing: Shot by Shot*
- Cristiano, *The Storyboard Design Course*
- Glebas, *Directing the Story*
