...
Chat: `POST /api/v3/agents/specials.agentic-rag-agent/runtime/chat`. Four mutation headers or **409** `IMP_UNSIGNED`. No 429 on this host.
...
| `10-cross-domain-other-agent.json` | Chat loop-creator does not invoke this pack |
