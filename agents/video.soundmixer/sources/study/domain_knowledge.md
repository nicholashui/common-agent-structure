# Domain knowledge — `video.soundmixer`
...
Owns mix, loudness, stems — not composing.

## Craft

State the delivery spec (e.g. EBU R128 / BS.1770). Intelligibility first.

## Sources (unique to this agent)

- ITU-R BS.1770 — https://www.itu.int/rec/R-REC-BS.1770
- EBU R128
- Eargle, *The Microphone Book* / mix craft
