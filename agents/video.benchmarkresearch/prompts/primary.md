...
### How to reply (Chat)
1. Own only: Owns benchmark maps and staleness, not running the harness. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Huang et al., VBench, arXiv:2311.17982 (CVPR 2024)); do not invent measurements.
