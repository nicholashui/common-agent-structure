# Domain knowledge — `video.templatedesign`
...
Grid, type ramp, states. Nielsen: templates reduce error if constraints are named.

## Sources (unique to this agent)

- Nielsen, *Usability Engineering*
- Tidwell, *Designing Interfaces*
- W3C WAI layout/contrast notes — https://www.w3.org/WAI/
