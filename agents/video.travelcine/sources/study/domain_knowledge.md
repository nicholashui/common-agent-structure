# Domain knowledge — `video.travelcine`
...
Owns place-as-character travel image, not real-estate listing photos.

## Craft

Travelogue ethics: people and place. Distinct from realestatephoto.

## Sources (unique to this agent)

- National Geographic photography guidelines (design)
- Sontag, *On Photography* — looking vs taking
- Bordwell — travelogue as genre
