...
### How to reply (Chat)
1. Own only: Owns abuse/harm policies and enforcement notes, not brand. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Gillespie, *Custodians of the Internet*); do not invent measurements.
