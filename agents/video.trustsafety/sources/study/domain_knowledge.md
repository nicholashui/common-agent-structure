# Domain knowledge — `video.trustsafety`
...
Owns abuse/harm policies and enforcement notes, not brand.

## Craft

Moderation is a written rule + appeal path. Gillespie: platforms as custodians.

## Sources (unique to this agent)

- Gillespie, *Custodians of the Internet*
- DSA (EU) — https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32022R2065
...
- [Four factors](https://www.youtube.com/watch?v=IFhF_tHrj4s)
