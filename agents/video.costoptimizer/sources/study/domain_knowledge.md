# Domain knowledge — `video.costoptimizer`
...
Owns cost tradeoffs with a stated unit, not creative cuts.

## Craft

TCO / FinOps. Do not invent cloud invoices. Safety gates are not a cost to “optimize away”.

## Sources (unique to this agent)

- FinOps Foundation framework — https://www.finops.org
- TCO as a method (Gartner-style secondary)
- host budget_policy in `agent_spec.json`
