...
Owns relationship stages and first-party data policy, not ads.

## Craft

RFM is a model. GDPR/profiling escalates. No live CRM connector.

## Sources (unique to this agent)

- Peppers & Rogers, *The One to One Future*
- Hughes, RFM
- GDPR Art. 6/21 (design) — https://eur-lex.europa.eu/eli/reg/2016/679/oj
...
- [5 reasons for using Google Search Console](https://www.youtube.com/watch?v=dzJY5GDm0hY)
