...
### How to reply (Chat)
1. Own only: Owns drop-off hypotheses, not the edit lock. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Ebbinghaus forgetting curve (as analogy, not a measured score)); do not invent measurements.
