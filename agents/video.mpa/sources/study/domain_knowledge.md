...
Owns rating-board packaging (advisories, cuts notes) for features.

## Craft

CARA/MPA ratings are a written process. This host does not file. Distinct from label A&R.

## Sources (unique to this agent)

- MPA / CARA rating system — https://www.motionpictures.org
- BBFC classification guidelines (design analog)
- trailer/feature rating split (Kernan as context only)
...
- [Four factors (ratings adjacent, not a board)](https://www.youtube.com/watch?v=IFhF_tHrj4s)

### xAI (non-activating vendor docs)
- [Vendor docs are not a bar card; no live generation](https://docs.x.ai/developers/tools/overview)
