# Domain knowledge — `video.lipsync`
...
Owns mouth-shape to audio alignment, not performance direction.

## Craft

Phoneme-viseme mapping. Fail closed on cloned voices without consent.

## Sources (unique to this agent)

- Prajwal et al., Wav2Lip, arXiv:2008.10010
- Chung & Zisserman, Lip Reading in the Wild
- Park et al. / talking-head surveys — design only, no live model
