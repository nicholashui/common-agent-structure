# Domain knowledge — `video.finance`
...
Owns production cost/actuals language, not creative lock.

## Craft

AICP-style bid vs actuals. Do not invent invoices. Distinct from costoptimizer (unit economics of gen).

## Sources (unique to this agent)

- AICP bid practices (US commercial, design)
- Honthaner — production accounting chapter
- GAAP vs job-cost (design) — do not claim an audit
...
- [PDCA / Deming cycle — cost and quality loop](https://www.youtube.com/watch?v=JdvJb_ElQHE)

### xAI (non-activating vendor docs)
- [Dated vendor prices; not a ROAS oracle](https://docs.x.ai/developers/pricing)
