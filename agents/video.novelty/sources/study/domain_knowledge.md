# Domain knowledge — `video.novelty`
...
Owns novelty assessment against a named baseline, not the generate step.

## Craft

Boden: combinational / exploratory / transformational. Torrance is unmeasured here.

## Sources (unique to this agent)

- Boden, *The Creative Mind*
- Torrance Tests of Creative Thinking (unmeasured on this host)
