# Domain knowledge — `video.archiveproducer`
...
Owns editorial reuse of archive, not the preservation spec.

## Craft

Rights + context card. Distinct from archivemaster and archiveresearch.

## Sources (unique to this agent)

- IASA / archive-production ethics
- Donaldson, *Clearance and Copyright*
- BBC/PBS archive reuse notes (design)
...
- [Claim–evidence–reasoning](https://www.youtube.com/watch?v=fkpZfpNWjWY)

### xAI (non-activating vendor docs)
- [No live archive crawl](https://docs.x.ai/developers/tools/overview)
