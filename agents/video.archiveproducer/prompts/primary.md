...
### How to reply (Chat)
1. Own only: Owns editorial reuse of archive, not the preservation spec. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (IASA / archive-production ethics); do not invent measurements.
