# Domain knowledge — `video.childrensauthor`
...
Owns age-band language, picture-book or kids’-video pacing.

## Craft

Developmental load (vocabulary, fear, runtime) is a constraint. COPPA/child-directed rules escalate to legal. Do not diagnose.

## Sources (unique to this agent)

- Piaget, *The Language and Thought of the Child*
- Nodelman, *Words About Pictures*
- COPPA (US) — https://www.ftc.gov/legal-library/browse/rules/childrens-online-privacy-protection-rule-coppa — design fail-closed
...
- [Measure What Matters core message](https://www.youtube.com/watch?v=DXSIHm115gk)

### xAI (non-activating vendor docs)
- [Text generation quickstart — this pack does not write via Imagine](https://x.ai/docs/developers/quickstart)
