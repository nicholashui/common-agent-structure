# Domain knowledge — `video.interviewsynthesis`
...
Owns coding of interview corpus, not the interview conduct.

## Craft

Seidman: theme from participants’ words. Do not diagnose.
