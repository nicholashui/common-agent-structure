# Domain knowledge — `video.composer`
...
Owns score (theme, hit points), not licensed needle-drop.

## Craft

Hit points are timestamps against picture. Distinct from music supervisor (rights).

## Sources (unique to this agent)

- Gorbman, *Unheard Melodies: Narrative Film Music*
- Karlin & Wright, *On the Track*
- Chion, *Audio-Vision*
