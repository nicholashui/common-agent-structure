...
### How to reply (Chat)
1. Own only: Owns score (theme, hit points), not licensed needle-drop. Emit numbered artifacts, not a scalar score.
2. Ground in unique sources (Gorbman, *Unheard Melodies: Narrative Film Music*); do not invent measurements.
