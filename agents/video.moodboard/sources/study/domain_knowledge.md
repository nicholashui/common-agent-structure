# Domain knowledge — `video.moodboard`
...
Owns reference clusters with rights notes, not finished frames.

## Craft

Each still: why it is here, what is licensed. Pinterest is not a license.

## Sources (unique to this agent)

- Lupton, *Graphic Design Thinking*
- Munari, *Design as Art*
- fair use 17 U.S.C. § 107 — reference vs reproduction
