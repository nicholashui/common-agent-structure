...
CASOPS v3 import of `vendor/common-agent-swarm-ops/business/specials/agents/specials.planner-agent` as `baseline_safe`.
...
Operator study and three-tier tests: `content/test_guide.md`. Skill `casops.skill.planner.traceable-tasks` declared, not host-granted.
