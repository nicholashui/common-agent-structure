# Domain knowledge — `video.marketing`
...
Owns offer, message, channel mix — not SEO tricks.

## Craft

KPI needs a window and a denominator. 4Ps as a checklist.
...
- [Welcome to Google Search Central](https://www.youtube.com/watch?v=lutawRrVTHw)
