...
CASOPS v3 import of `vendor/common-agent-swarm-ops/business/specials/agents/specials.screenwriter-strategic-goal-achievement-agent` as `baseline_safe`.
...
Operator study and three-tier tests: `content/test_guide.md`. Skill `casops.skill.screen_okr.kr-pages` declared, not host-granted.
