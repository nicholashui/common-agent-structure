...
Chat: `POST /api/v3/agents/specials.screenwriter-strategic-goal-achievement-agent/runtime/chat`. Four mutation headers or **409** `IMP_UNSIGNED`. No 429 on this host.
