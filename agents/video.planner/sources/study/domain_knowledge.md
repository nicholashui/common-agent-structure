# Domain knowledge — `video.planner`
...
Owns critical path and dependencies, not the creative lock.

## Craft

CPM/PERT. Goldratt: the constraint. Distinct from producer (people/money) and orchestrator (agent hops).
...
- [Doerr / What Matters, Why OKRs](https://www.youtube.com/watch?v=1wOi7GGZShc)
